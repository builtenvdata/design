...
if __name__ == '__main__':
    ...
    fim.do_modal(num_modes=2, out_dir=modal_dir)
    # Plot the model and save
    fim.plot_model(directory=outdir_building, show=True)
    # Plot the first two mode shapes and save
    fim.plot_mode_shape(mode_number=1, contour='x', show=True,
                        directory=outdir_building)
    fim.plot_mode_shape(mode_number=2, contour='y', show=True,
                        directory=outdir_building)
