"""
The model used for detailing the structural members of eu_cdm buildings.
"""
...
class Rebars(RebarsBase):
    ...
    def beam_max_sbl(self) -> float | np.ndarray:
        ...
        -----
        art 91 of REBAP
        The maximum of the tensile reinforcement rebars (so both on the top
        and bottom of the beam) cannot be space by more than
            10cm for fyk=400 MPa
