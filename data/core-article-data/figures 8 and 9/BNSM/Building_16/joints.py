...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 0.0, 0.0, 1.575, '-mass', 3.479867482161061, 3.479867482161061, 3.479867482161061, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34025, 0.125, 0.0, 1.575)
    ...
    # Central joint node
    ops.node(4026, 3.1, 0.0, 1.575, '-mass', 3.913353720693171, 3.913353720693171, 3.913353720693171, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4027, 0.0, 0.0, 4.725, '-mass', 3.479867482161061, 3.479867482161061, 3.479867482161061, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34027, 0.125, 0.0, 4.725)
    ...
    # Central joint node
    ops.node(4028, 3.1, 0.0, 4.725, '-mass', 3.913353720693171, 3.913353720693171, 3.913353720693171, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4029, 0.0, 0.0, 7.875, '-mass', 3.4324668705402654, 3.4324668705402654, 3.4324668705402654, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4030, 3.1, 0.0, 7.875, '-mass', 3.5769622833843018, 3.5769622833843018, 3.5769622833843018, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4032, 3.1, 0.0, 11.025, '-mass', 3.5011213047910297, 3.5011213047910297, 3.5011213047910297, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.15, '-mass', 2.8427624872579003, 2.8427624872579003, 2.8427624872579003, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.uniaxialMaterial('Elastic', 301001, 33265.4477)
    ops.uniaxialMaterial('Elastic', 401001, 33265.4477)
    ...
    # Central joint node
    ops.node(1002, 3.1, 0.0, 3.15, '-mass', 9.686232161060142, 9.686232161060142, 9.686232161060142, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21002, 3.1, 0.0, 2.925)
    ops.element('elasticBeamColumn', 21002, 21002, 1002, 99999, 99999)
    ops.node(71002, 3.1, 0.0, 3.375)
    ops.element('elasticBeamColumn', 71002, 1002, 71002, 99999, 99999)
    ops.node(41002, 3.1, 0.25, 3.15)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 80957.93495)
    ops.uniaxialMaterial('Elastic', 401002, 105574.6104)
    ...
    # Central joint node
    ops.node(1003, 7.35, 0.0, 3.15, '-mass', 14.908957696228336, 14.908957696228336, 14.908957696228336, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21003, 7.35, 0.0, 2.925)
    ops.element('elasticBeamColumn', 21003, 21003, 1003, 99999, 99999)
    ops.node(71003, 7.35, 0.0, 3.375)
    ops.element('elasticBeamColumn', 71003, 1003, 71003, 99999, 99999)
    ops.node(41003, 7.35, 0.275, 3.15)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 79378.9256)
    ops.uniaxialMaterial('Elastic', 401003, 99176.05335)
    ...
    # Central joint node
    ops.node(1004, 11.6, 0.0, 3.15, '-mass', 9.394489041794087, 9.394489041794087, 9.394489041794087, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 11.45, 0.0, 3.15)
    ...
    ops.node(41004, 11.6, 0.175, 3.15)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 45490.85965)
    ops.uniaxialMaterial('Elastic', 401004, 46032.4485)
    ...
    # Central joint node
    ops.node(1005, 0.0, 4.4, 3.15, '-mass', 10.623725790010194, 10.623725790010194, 10.623725790010194, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.2, 4.4, 3.15)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 68999.5118)
    ops.uniaxialMaterial('Elastic', 401005, 43934.3495)
    ...
    # Central joint node
    ops.node(1006, 3.1, 4.4, 3.15, '-mass', 19.17396788990826, 19.17396788990826, 19.17396788990826, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51006, 2.775, 4.4, 3.15)
    ops.element('elasticBeamColumn', 51006, 51006, 1006, 99999, 88888)
    ops.node(31006, 3.425, 4.4, 3.15)
    ops.element('elasticBeamColumn', 31006, 1006, 31006, 99999, 88888)
    ops.node(21006, 3.1, 4.4, 2.925)
    ops.element('elasticBeamColumn', 21006, 21006, 1006, 99999, 99999)
    ops.node(71006, 3.1, 4.4, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 113400.1759)
    ops.uniaxialMaterial('Elastic', 401006, 123411.01975)
    ...
    # Central joint node
    ops.node(1007, 7.35, 4.4, 3.15, '-mass', 21.797935779816516, 21.797935779816516, 21.797935779816516, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51007, 6.975, 4.4, 3.15)
    ops.element('elasticBeamColumn', 51007, 51007, 1007, 99999, 88888)
    ops.node(31007, 7.725, 4.4, 3.15)
    ops.element('elasticBeamColumn', 31007, 1007, 31007, 99999, 88888)
    ops.node(21007, 7.35, 4.4, 2.925)
    ops.element('elasticBeamColumn', 21007, 21007, 1007, 99999, 99999)
    ops.node(71007, 7.35, 4.4, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 132058.75675)
    ops.uniaxialMaterial('Elastic', 401007, 150261.863)
    ...
    # Central joint node
    ops.node(1008, 11.6, 4.4, 3.15, '-mass', 14.759722222222221, 14.759722222222221, 14.759722222222221, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 11.325, 4.4, 3.15)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 88951.3769)
    ops.uniaxialMaterial('Elastic', 401008, 63847.39005)
    ...
    # Central joint node
    ops.node(1009, 0.0, 8.8, 3.15, '-mass', 11.22808358817533, 11.22808358817533, 11.22808358817533, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31009, 0.2, 8.8, 3.15)
    ...
    ops.node(61009, 0.0, 8.675, 3.15)
    ops.element('elasticBeamColumn', 61009, 61009, 1009, 99999, 77777)
    ops.node(41009, 0.0, 8.925, 3.15)
    ops.element('elasticBeamColumn', 41009, 1009, 41009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 68710.61935)
    ops.uniaxialMaterial('Elastic', 401009, 43757.3595)
    ...
    # Central joint node
    ops.node(1010, 3.1, 8.8, 3.15, '-mass', 18.208498980632005, 18.208498980632005, 18.208498980632005, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 2.775, 8.8, 3.15)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 3.425, 8.8, 3.15)
    ops.element('elasticBeamColumn', 31010, 1010, 31010, 99999, 88888)
    ops.node(21010, 3.1, 8.8, 2.925)
    ops.element('elasticBeamColumn', 21010, 21010, 1010, 99999, 99999)
    ops.node(71010, 3.1, 8.8, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 110913.1919)
    ops.uniaxialMaterial('Elastic', 401010, 120728.32185)
    ...
    # Central joint node
    ops.node(1011, 7.35, 8.8, 3.15, '-mass', 21.797935779816513, 21.797935779816513, 21.797935779816513, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 6.975, 8.8, 3.15)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 7.725, 8.8, 3.15)
    ops.element('elasticBeamColumn', 31011, 1011, 31011, 99999, 88888)
    ops.node(21011, 7.35, 8.8, 2.925)
    ops.element('elasticBeamColumn', 21011, 21011, 1011, 99999, 99999)
    ops.node(71011, 7.35, 8.8, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 131948.9623)
    ops.uniaxialMaterial('Elastic', 401011, 150138.4098)
    ...
    # Central joint node
    ops.node(1012, 11.6, 8.8, 3.15, '-mass', 14.75972222222222, 14.75972222222222, 14.75972222222222, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 11.325, 8.8, 3.15)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 88888.6875)
    ops.uniaxialMaterial('Elastic', 401012, 63803.8262)
    ...
    # Central joint node
    ops.node(1013, 0.0, 13.2, 3.15, '-mass', 11.22808358817533, 11.22808358817533, 11.22808358817533, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.2, 13.2, 3.15)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 68710.61935)
    ops.uniaxialMaterial('Elastic', 401013, 43757.3595)
    ...
    # Central joint node
    ops.node(1014, 3.1, 13.2, 3.15, '-mass', 18.208498980632008, 18.208498980632008, 18.208498980632008, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 2.775, 13.2, 3.15)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 3.425, 13.2, 3.15)
    ops.element('elasticBeamColumn', 31014, 1014, 31014, 99999, 88888)
    ops.node(21014, 3.1, 13.2, 2.925)
    ops.element('elasticBeamColumn', 21014, 21014, 1014, 99999, 99999)
    ops.node(71014, 3.1, 13.2, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 110913.1919)
    ops.uniaxialMaterial('Elastic', 401014, 120728.32185)
    ...
    # Central joint node
    ops.node(1015, 7.35, 13.2, 3.15, '-mass', 21.797935779816513, 21.797935779816513, 21.797935779816513, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 6.975, 13.2, 3.15)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 7.725, 13.2, 3.15)
    ops.element('elasticBeamColumn', 31015, 1015, 31015, 99999, 88888)
    ops.node(21015, 7.35, 13.2, 2.925)
    ops.element('elasticBeamColumn', 21015, 21015, 1015, 99999, 99999)
    ops.node(71015, 7.35, 13.2, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 131948.9623)
    ops.uniaxialMaterial('Elastic', 401015, 150138.4098)
    ...
    # Central joint node
    ops.node(1016, 11.6, 13.2, 3.15, '-mass', 14.759722222222221, 14.759722222222221, 14.759722222222221, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 11.325, 13.2, 3.15)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 88888.6875)
    ops.uniaxialMaterial('Elastic', 401016, 63803.8262)
    ...
    # Central joint node
    ops.node(1017, 0.0, 17.6, 3.15, '-mass', 11.22808358817533, 11.22808358817533, 11.22808358817533, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31017, 0.2, 17.6, 3.15)
    ...
    ops.node(61017, 0.0, 17.475, 3.15)
    ops.element('elasticBeamColumn', 61017, 61017, 1017, 99999, 77777)
    ops.node(41017, 0.0, 17.725, 3.15)
    ops.element('elasticBeamColumn', 41017, 1017, 41017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301017, 68710.61935)
    ops.uniaxialMaterial('Elastic', 401017, 43757.3595)
    ...
    # Central joint node
    ops.node(1018, 3.1, 17.6, 3.15, '-mass', 18.208498980632008, 18.208498980632008, 18.208498980632008, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51018, 2.775, 17.6, 3.15)
    ops.element('elasticBeamColumn', 51018, 51018, 1018, 99999, 88888)
    ops.node(31018, 3.425, 17.6, 3.15)
    ops.element('elasticBeamColumn', 31018, 1018, 31018, 99999, 88888)
    ops.node(21018, 3.1, 17.6, 2.925)
    ops.element('elasticBeamColumn', 21018, 21018, 1018, 99999, 99999)
    ops.node(71018, 3.1, 17.6, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301018, 110913.1919)
    ops.uniaxialMaterial('Elastic', 401018, 120728.32185)
    ...
    # Central joint node
    ops.node(1019, 7.35, 17.6, 3.15, '-mass', 21.797935779816513, 21.797935779816513, 21.797935779816513, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51019, 6.975, 17.6, 3.15)
    ops.element('elasticBeamColumn', 51019, 51019, 1019, 99999, 88888)
    ops.node(31019, 7.725, 17.6, 3.15)
    ops.element('elasticBeamColumn', 31019, 1019, 31019, 99999, 88888)
    ops.node(21019, 7.35, 17.6, 2.925)
    ops.element('elasticBeamColumn', 21019, 21019, 1019, 99999, 99999)
    ops.node(71019, 7.35, 17.6, 3.375)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301019, 131948.9623)
    ops.uniaxialMaterial('Elastic', 401019, 150138.4098)
    ...
    # Central joint node
    ops.node(1020, 11.6, 17.6, 3.15, '-mass', 14.759722222222221, 14.759722222222221, 14.759722222222221, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51020, 11.325, 17.6, 3.15)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301020, 88888.6875)
    ops.uniaxialMaterial('Elastic', 401020, 63803.8262)
    ...
    # Central joint node
    ops.node(1021, 0.0, 22.0, 3.15, '-mass', 7.100790010193679, 7.100790010193679, 7.100790010193679, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31021, 0.125, 22.0, 3.15)
    ops.element('elasticBeamColumn', 31021, 1021, 31021, 99999, 88888)
    ops.node(21021, 0.0, 22.0, 2.9)
    ops.element('elasticBeamColumn', 21021, 21021, 1021, 99999, 99999)
    ops.node(71021, 0.0, 22.0, 3.4)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301021, 31187.46865)
    ops.uniaxialMaterial('Elastic', 401021, 35508.17345)
    ...
    # Central joint node
    ops.node(1022, 3.1, 22.0, 3.15, '-mass', 12.738041539245666, 12.738041539245666, 12.738041539245666, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61022, 3.1, 21.775, 3.15)
    ops.element('elasticBeamColumn', 61022, 61022, 1022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301022, 67268.69705)
    ops.uniaxialMaterial('Elastic', 401022, 104054.72095)
    ...
    # Central joint node
    ops.node(1023, 7.35, 22.0, 3.15, '-mass', 15.250853720693167, 15.250853720693167, 15.250853720693167, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51023, 7.15, 22.0, 3.15)
    ops.element('elasticBeamColumn', 51023, 51023, 1023, 99999, 88888)
    ops.node(31023, 7.55, 22.0, 3.15)
    ...
    ops.node(61023, 7.35, 21.725, 3.15)
    ops.element('elasticBeamColumn', 61023, 61023, 1023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301023, 85767.49935)
    ops.uniaxialMaterial('Elastic', 401023, 124132.1524)
    ...
    # Central joint node
    ops.node(1024, 11.6, 22.0, 3.15, '-mass', 9.459473751274205, 9.459473751274205, 9.459473751274205, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51024, 11.45, 22.0, 3.15)
    ops.element('elasticBeamColumn', 51024, 51024, 1024, 99999, 88888)
    ops.node(21024, 11.6, 22.0, 2.9)
    ops.element('elasticBeamColumn', 21024, 21024, 1024, 99999, 99999)
    ops.node(71024, 11.6, 22.0, 3.4)
    ops.element('elasticBeamColumn', 71024, 1024, 71024, 99999, 99999)
    ops.node(61024, 11.6, 21.825, 3.15)
    ops.element('elasticBeamColumn', 61024, 61024, 1024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301024, 45547.4488)
    ops.uniaxialMaterial('Elastic', 401024, 52445.0424)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 6.3, '-mass', 2.7953618756371053, 2.7953618756371053, 2.7953618756371053, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 28370.2151)
    ops.uniaxialMaterial('Elastic', 402001, 24095.4007)
    ...
    # Central joint node
    ops.node(2002, 3.1, 0.0, 6.3, '-mass', 9.429351427115188, 9.429351427115188, 9.429351427115188, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42002, 3.1, 0.25, 6.3)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 68959.8839)
    ops.uniaxialMaterial('Elastic', 402002, 76779.2404)
    ...
    # Central joint node
    ops.node(2003, 7.35, 0.0, 6.3, '-mass', 14.518896534148828, 14.518896534148828, 14.518896534148828, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42003, 7.35, 0.275, 6.3)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 68103.1324)
    ops.uniaxialMaterial('Elastic', 402003, 74072.2401)
    ...
    # Central joint node
    ops.node(2004, 11.6, 0.0, 6.3, '-mass', 9.165742864424056, 9.165742864424056, 9.165742864424056, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 11.45, 0.0, 6.3)
    ...
    ops.node(42004, 11.6, 0.175, 6.3)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 39085.13385)
    ops.uniaxialMaterial('Elastic', 402004, 34350.69855)
    ...
    # Central joint node
    ops.node(2005, 0.0, 4.4, 6.3, '-mass', 10.499719673802245, 10.499719673802245, 10.499719673802245, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.2, 4.4, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 55149.2256)
    ops.uniaxialMaterial('Elastic', 402005, 38010.12785)
    ...
    # Central joint node
    ops.node(2006, 3.1, 4.4, 6.3, '-mass', 18.6473623853211, 18.6473623853211, 18.6473623853211, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52006, 2.775, 4.4, 6.3)
    ops.element('elasticBeamColumn', 52006, 52006, 2006, 99999, 88888)
    ops.node(32006, 3.425, 4.4, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 91454.7111)
    ops.uniaxialMaterial('Elastic', 402006, 106259.10955)
    ...
    # Central joint node
    ops.node(2007, 7.35, 4.4, 6.3, '-mass', 21.310626911314987, 21.310626911314987, 21.310626911314987, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52007, 6.975, 4.4, 6.3)
    ops.element('elasticBeamColumn', 52007, 52007, 2007, 99999, 88888)
    ops.node(32007, 7.725, 4.4, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 106622.3733)
    ops.uniaxialMaterial('Elastic', 402007, 129126.55275)
    ...
    # Central joint node
    ops.node(2008, 11.6, 4.4, 6.3, '-mass', 14.501618246687055, 14.501618246687055, 14.501618246687055, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 11.325, 4.4, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 70841.9514)
    ops.uniaxialMaterial('Elastic', 402008, 54737.45495)
    ...
    # Central joint node
    ops.node(2009, 0.0, 8.8, 6.3, '-mass', 11.104077471967377, 11.104077471967377, 11.104077471967377, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32009, 0.2, 8.8, 6.3)
    ...
    ops.node(62009, 0.0, 8.675, 6.3)
    ops.element('elasticBeamColumn', 62009, 62009, 2009, 99999, 77777)
    ops.node(42009, 0.0, 8.925, 6.3)
    ops.element('elasticBeamColumn', 42009, 2009, 42009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 54307.74245)
    ops.uniaxialMaterial('Elastic', 402009, 37456.53775)
    ...
    # Central joint node
    ops.node(2010, 3.1, 8.8, 6.3, '-mass', 17.681893476044852, 17.681893476044852, 17.681893476044852, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 2.775, 8.8, 6.3)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 3.425, 8.8, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 89039.16095)
    ops.uniaxialMaterial('Elastic', 402010, 103493.3752)
    ...
    # Central joint node
    ops.node(2011, 7.35, 8.8, 6.3, '-mass', 21.31062691131498, 21.31062691131498, 21.31062691131498, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 6.975, 8.8, 6.3)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 7.725, 8.8, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 106501.47715)
    ops.uniaxialMaterial('Elastic', 402011, 128982.87195)
    ...
    # Central joint node
    ops.node(2012, 11.6, 8.8, 6.3, '-mass', 14.501618246687054, 14.501618246687054, 14.501618246687054, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 11.325, 8.8, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 70773.06675)
    ops.uniaxialMaterial('Elastic', 402012, 54686.30875)
    ...
    # Central joint node
    ops.node(2013, 0.0, 13.2, 6.3, '-mass', 11.104077471967381, 11.104077471967381, 11.104077471967381, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32013, 0.2, 13.2, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 54307.74245)
    ops.uniaxialMaterial('Elastic', 402013, 37456.53775)
    ...
    # Central joint node
    ops.node(2014, 3.1, 13.2, 6.3, '-mass', 17.681893476044852, 17.681893476044852, 17.681893476044852, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 2.775, 13.2, 6.3)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 3.425, 13.2, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 89039.16095)
    ops.uniaxialMaterial('Elastic', 402014, 103493.3752)
    ...
    # Central joint node
    ops.node(2015, 7.35, 13.2, 6.3, '-mass', 21.310626911314987, 21.310626911314987, 21.310626911314987, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 6.975, 13.2, 6.3)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 7.725, 13.2, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 106501.47715)
    ops.uniaxialMaterial('Elastic', 402015, 128982.87195)
    ...
    # Central joint node
    ops.node(2016, 11.6, 13.2, 6.3, '-mass', 14.501618246687054, 14.501618246687054, 14.501618246687054, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 11.325, 13.2, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 70773.06675)
    ops.uniaxialMaterial('Elastic', 402016, 54686.30875)
    ...
    # Central joint node
    ops.node(2017, 0.0, 17.6, 6.3, '-mass', 11.104077471967381, 11.104077471967381, 11.104077471967381, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32017, 0.2, 17.6, 6.3)
    ...
    ops.node(62017, 0.0, 17.475, 6.3)
    ops.element('elasticBeamColumn', 62017, 62017, 2017, 99999, 77777)
    ops.node(42017, 0.0, 17.725, 6.3)
    ops.element('elasticBeamColumn', 42017, 2017, 42017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302017, 54307.74245)
    ops.uniaxialMaterial('Elastic', 402017, 37456.53775)
    ...
    # Central joint node
    ops.node(2018, 3.1, 17.6, 6.3, '-mass', 17.681893476044852, 17.681893476044852, 17.681893476044852, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52018, 2.775, 17.6, 6.3)
    ops.element('elasticBeamColumn', 52018, 52018, 2018, 99999, 88888)
    ops.node(32018, 3.425, 17.6, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302018, 89039.16095)
    ops.uniaxialMaterial('Elastic', 402018, 103493.3752)
    ...
    # Central joint node
    ops.node(2019, 7.35, 17.6, 6.3, '-mass', 21.310626911314987, 21.310626911314987, 21.310626911314987, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52019, 6.975, 17.6, 6.3)
    ops.element('elasticBeamColumn', 52019, 52019, 2019, 99999, 88888)
    ops.node(32019, 7.725, 17.6, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302019, 106501.47715)
    ops.uniaxialMaterial('Elastic', 402019, 128982.87195)
    ...
    # Central joint node
    ops.node(2020, 11.6, 17.6, 6.3, '-mass', 14.501618246687054, 14.501618246687054, 14.501618246687054, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52020, 11.325, 17.6, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302020, 70773.06675)
    ops.uniaxialMaterial('Elastic', 402020, 54686.30875)
    ...
    # Central joint node
    ops.node(2021, 0.0, 22.0, 6.3, '-mass', 7.053389398572882, 7.053389398572882, 7.053389398572882, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32021, 0.125, 22.0, 6.3)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302021, 26837.4619)
    ops.uniaxialMaterial('Elastic', 402021, 26837.4619)
    ...
    # Central joint node
    ops.node(2022, 3.1, 22.0, 6.3, '-mass', 12.355931447502547, 12.355931447502547, 12.355931447502547, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62022, 3.1, 21.775, 6.3)
    ops.element('elasticBeamColumn', 62022, 62022, 2022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302022, 57703.7502)
    ops.uniaxialMaterial('Elastic', 402022, 78590.5668)
    ...
    # Central joint node
    ops.node(2023, 7.35, 22.0, 6.3, '-mass', 14.947489806320077, 14.947489806320077, 14.947489806320077, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52023, 7.15, 22.0, 6.3)
    ops.element('elasticBeamColumn', 52023, 52023, 2023, 99999, 88888)
    ops.node(32023, 7.55, 22.0, 6.3)
    ...
    ops.node(62023, 7.35, 21.725, 6.3)
    ops.element('elasticBeamColumn', 62023, 62023, 2023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302023, 73662.2286)
    ops.uniaxialMaterial('Elastic', 402023, 93951.0401)
    ...
    # Central joint node
    ops.node(2024, 11.6, 22.0, 6.3, '-mass', 9.230727573904176, 9.230727573904176, 9.230727573904176, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62024, 11.6, 21.825, 6.3)
    ops.element('elasticBeamColumn', 62024, 62024, 2024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302024, 39118.4604)
    ops.uniaxialMaterial('Elastic', 402024, 39666.87015)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 21599.78475)
    ops.uniaxialMaterial('Elastic', 403001, 18261.3102)
    ...
    # Central joint node
    ops.node(3002, 3.1, 0.0, 9.45, '-mass', 9.105039500509683, 9.105039500509683, 9.105039500509683, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43002, 3.1, 0.2, 9.45)
    ops.element('elasticBeamColumn', 43002, 3002, 43002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 40130.6298)
    ops.uniaxialMaterial('Elastic', 403002, 46290.40645)
    ...
    # Central joint node
    ops.node(3003, 7.35, 0.0, 9.45, '-mass', 14.050853720693171, 14.050853720693171, 14.050853720693171, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43003, 7.35, 0.25, 9.45)
    ops.element('elasticBeamColumn', 43003, 3003, 43003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 43346.3614)
    ops.uniaxialMaterial('Elastic', 403003, 46112.9925)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 24237.5027)
    ops.uniaxialMaterial('Elastic', 403004, 20964.1217)
    ...
    # Central joint node
    ops.node(3005, 0.0, 4.4, 9.45, '-mass', 10.451554536187565, 10.451554536187565, 10.451554536187565, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33005, 0.175, 4.4, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 44399.3279)
    ops.uniaxialMaterial('Elastic', 403005, 29039.51205)
    ...
    # Central joint node
    ops.node(3006, 3.1, 4.4, 9.45, '-mass', 18.300573394495412, 18.300573394495412, 18.300573394495412, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53006, 2.825, 4.4, 9.45)
    ops.element('elasticBeamColumn', 53006, 53006, 3006, 99999, 88888)
    ops.node(33006, 3.375, 4.4, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 57578.96445)
    ops.uniaxialMaterial('Elastic', 403006, 66061.77005)
    ...
    # Central joint node
    ops.node(3007, 7.35, 4.4, 9.45, '-mass', 21.031269113149847, 21.031269113149847, 21.031269113149847, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53007, 7.025, 4.4, 9.45)
    ops.element('elasticBeamColumn', 53007, 53007, 3007, 99999, 88888)
    ops.node(33007, 7.675, 4.4, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 77082.1737)
    ops.uniaxialMaterial('Elastic', 403007, 89821.7414)
    ...
    # Central joint node
    ops.node(3008, 11.6, 4.4, 9.45, '-mass', 14.347489806320084, 14.347489806320084, 14.347489806320084, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 11.35, 4.4, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 49083.80215)
    ops.uniaxialMaterial('Elastic', 403008, 37856.1242)
    ...
    # Central joint node
    ops.node(3009, 0.0, 8.8, 9.45, '-mass', 11.017991845056063, 11.017991845056063, 11.017991845056063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33009, 0.175, 8.8, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 42679.81835)
    ops.uniaxialMaterial('Elastic', 403009, 23909.21125)
    ...
    # Central joint node
    ops.node(3010, 3.1, 8.8, 9.45, '-mass', 17.24519622833843, 17.24519622833843, 17.24519622833843, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53010, 2.825, 8.8, 9.45)
    ops.element('elasticBeamColumn', 53010, 53010, 3010, 99999, 88888)
    ops.node(33010, 3.375, 8.8, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 55500.0273)
    ops.uniaxialMaterial('Elastic', 403010, 54957.2724)
    ...
    # Central joint node
    ops.node(3011, 7.35, 8.8, 9.45, '-mass', 20.92729357798165, 20.92729357798165, 20.92729357798165, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53011, 7.025, 8.8, 9.45)
    ops.element('elasticBeamColumn', 53011, 53011, 3011, 99999, 88888)
    ops.node(33011, 7.675, 8.8, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 76944.9508)
    ops.uniaxialMaterial('Elastic', 403011, 77348.42685)
    ...
    # Central joint node
    ops.node(3012, 11.6, 8.8, 9.45, '-mass', 14.295502038735984, 14.295502038735984, 14.295502038735984, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 11.35, 8.8, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 49006.8469)
    ops.uniaxialMaterial('Elastic', 403012, 32385.3329)
    ...
    # Central joint node
    ops.node(3013, 0.0, 13.2, 9.45, '-mass', 11.017991845056065, 11.017991845056065, 11.017991845056065, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33013, 0.175, 13.2, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 42679.81835)
    ops.uniaxialMaterial('Elastic', 403013, 23909.21125)
    ...
    # Central joint node
    ops.node(3014, 3.1, 13.2, 9.45, '-mass', 17.24519622833843, 17.24519622833843, 17.24519622833843, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53014, 2.825, 13.2, 9.45)
    ops.element('elasticBeamColumn', 53014, 53014, 3014, 99999, 88888)
    ops.node(33014, 3.375, 13.2, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 55500.0273)
    ops.uniaxialMaterial('Elastic', 403014, 54957.2724)
    ...
    # Central joint node
    ops.node(3015, 7.35, 13.2, 9.45, '-mass', 20.92729357798165, 20.92729357798165, 20.92729357798165, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53015, 7.025, 13.2, 9.45)
    ops.element('elasticBeamColumn', 53015, 53015, 3015, 99999, 88888)
    ops.node(33015, 7.675, 13.2, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 76944.9508)
    ops.uniaxialMaterial('Elastic', 403015, 77348.42685)
    ...
    # Central joint node
    ops.node(3016, 11.6, 13.2, 9.45, '-mass', 14.295502038735984, 14.295502038735984, 14.295502038735984, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53016, 11.35, 13.2, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 49006.8469)
    ops.uniaxialMaterial('Elastic', 403016, 32385.3329)
    ...
    # Central joint node
    ops.node(3017, 0.0, 17.6, 9.45, '-mass', 11.017991845056065, 11.017991845056065, 11.017991845056065, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33017, 0.175, 17.6, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303017, 42679.81835)
    ops.uniaxialMaterial('Elastic', 403017, 23909.21125)
    ...
    # Central joint node
    ops.node(3018, 3.1, 17.6, 9.45, '-mass', 17.24519622833843, 17.24519622833843, 17.24519622833843, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 2.825, 17.6, 9.45)
    ops.element('elasticBeamColumn', 53018, 53018, 3018, 99999, 88888)
    ops.node(33018, 3.375, 17.6, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303018, 55500.0273)
    ops.uniaxialMaterial('Elastic', 403018, 54957.2724)
    ...
    # Central joint node
    ops.node(3019, 7.35, 17.6, 9.45, '-mass', 20.92729357798165, 20.92729357798165, 20.92729357798165, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53019, 7.025, 17.6, 9.45)
    ops.element('elasticBeamColumn', 53019, 53019, 3019, 99999, 88888)
    ops.node(33019, 7.675, 17.6, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303019, 76944.9508)
    ops.uniaxialMaterial('Elastic', 403019, 77348.42685)
    ...
    # Central joint node
    ops.node(3020, 11.6, 17.6, 9.45, '-mass', 14.295502038735984, 14.295502038735984, 14.295502038735984, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53020, 11.35, 17.6, 9.45)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303020, 49006.8469)
    ops.uniaxialMaterial('Elastic', 403020, 32385.3329)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303021, 21543.8996)
    ops.uniaxialMaterial('Elastic', 403021, 18600.32405)
    ...
    # Central joint node
    ops.node(3022, 3.1, 22.0, 9.45, '-mass', 11.794004841997959, 11.794004841997959, 11.794004841997959, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63022, 3.1, 21.825, 9.45)
    ops.element('elasticBeamColumn', 63022, 63022, 3022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303022, 34058.38995)
    ops.uniaxialMaterial('Elastic', 403022, 41210.3872)
    ...
    # Central joint node
    ops.node(3023, 7.35, 22.0, 9.45, '-mass', 14.436174821610598, 14.436174821610598, 14.436174821610598, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53023, 7.175, 22.0, 9.45)
    ops.element('elasticBeamColumn', 53023, 53023, 3023, 99999, 88888)
    ops.node(33023, 7.525, 22.0, 9.45)
    ...
    ops.node(63023, 7.35, 21.75, 9.45)
    ops.element('elasticBeamColumn', 63023, 63023, 3023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303023, 52425.6184)
    ops.uniaxialMaterial('Elastic', 403023, 59049.9244)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303024, 24237.5027)
    ops.uniaxialMaterial('Elastic', 403024, 20964.1217)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 10357.92245)
    ops.uniaxialMaterial('Elastic', 404001, 8440.59485)
    ...
    # Central joint node
    ops.node(4002, 3.1, 0.0, 12.6, '-mass', 5.145374617737002, 5.145374617737002, 5.145374617737002, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44002, 3.1, 0.2, 12.6)
    ops.element('elasticBeamColumn', 44002, 4002, 44002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 27708.17805)
    ops.uniaxialMaterial('Elastic', 404002, 20552.8611)
    ...
    # Central joint node
    ops.node(4003, 7.35, 0.0, 12.6, '-mass', 9.393807339449541, 9.393807339449541, 9.393807339449541, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44003, 7.35, 0.25, 12.6)
    ops.element('elasticBeamColumn', 44003, 4003, 44003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 39429.5858)
    ops.uniaxialMaterial('Elastic', 404003, 26194.85625)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 18720.04685)
    ops.uniaxialMaterial('Elastic', 404004, 15664.90895)
    ...
    # Central joint node
    ops.node(4005, 0.0, 4.4, 12.6, '-mass', 6.135677879714578, 6.135677879714578, 6.135677879714578, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34005, 0.175, 4.4, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 28510.25925)
    ops.uniaxialMaterial('Elastic', 404005, 28572.82035)
    ...
    # Central joint node
    ops.node(4006, 3.1, 4.4, 12.6, '-mass', 14.765265035677881, 14.765265035677881, 14.765265035677881, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54006, 2.825, 4.4, 12.6)
    ops.element('elasticBeamColumn', 54006, 54006, 4006, 99999, 88888)
    ops.node(34006, 3.375, 4.4, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 41209.57435)
    ops.uniaxialMaterial('Elastic', 404006, 44511.69055)
    ...
    # Central joint node
    ops.node(4007, 7.35, 4.4, 12.6, '-mass', 18.18103975535168, 18.18103975535168, 18.18103975535168, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54007, 7.025, 4.4, 12.6)
    ops.element('elasticBeamColumn', 54007, 54007, 4007, 99999, 88888)
    ops.node(34007, 7.675, 4.4, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 52657.853)
    ops.uniaxialMaterial('Elastic', 404007, 58903.8079)
    ...
    # Central joint node
    ops.node(4008, 11.6, 4.4, 12.6, '-mass', 9.349159021406727, 9.349159021406727, 9.349159021406727, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 11.35, 4.4, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 28633.00395)
    ops.uniaxialMaterial('Elastic', 404008, 34012.8174)
    ...
    # Central joint node
    ops.node(4009, 0.0, 8.8, 12.6, '-mass', 6.358460754332313, 6.358460754332313, 6.358460754332313, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34009, 0.175, 8.8, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 24516.17505)
    ops.uniaxialMaterial('Elastic', 404009, 20558.7264)
    ...
    # Central joint node
    ops.node(4010, 3.1, 8.8, 12.6, '-mass', 14.936060142711518, 14.936060142711518, 14.936060142711518, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 2.825, 8.8, 12.6)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 3.375, 8.8, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 38195.4743)
    ops.uniaxialMaterial('Elastic', 404010, 34869.9362)
    ...
    # Central joint node
    ops.node(4011, 7.35, 8.8, 12.6, '-mass', 18.077064220183484, 18.077064220183484, 18.077064220183484, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 7.025, 8.8, 12.6)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 7.675, 8.8, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 52532.25155)
    ops.uniaxialMaterial('Elastic', 404011, 49875.6754)
    ...
    # Central joint node
    ops.node(4012, 11.6, 8.8, 12.6, '-mass', 9.29717125382263, 9.29717125382263, 9.29717125382263, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 11.35, 8.8, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 28568.25895)
    ops.uniaxialMaterial('Elastic', 404012, 28729.56445)
    ...
    # Central joint node
    ops.node(4013, 0.0, 13.2, 12.6, '-mass', 6.358460754332315, 6.358460754332315, 6.358460754332315, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 0.175, 13.2, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 24516.17505)
    ops.uniaxialMaterial('Elastic', 404013, 20558.7264)
    ...
    # Central joint node
    ops.node(4014, 3.1, 13.2, 12.6, '-mass', 14.936060142711518, 14.936060142711518, 14.936060142711518, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 2.825, 13.2, 12.6)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 3.375, 13.2, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 38195.4743)
    ops.uniaxialMaterial('Elastic', 404014, 34869.9362)
    ...
    # Central joint node
    ops.node(4015, 7.35, 13.2, 12.6, '-mass', 18.077064220183484, 18.077064220183484, 18.077064220183484, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 7.025, 13.2, 12.6)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 7.675, 13.2, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 52532.25155)
    ops.uniaxialMaterial('Elastic', 404015, 49875.6754)
    ...
    # Central joint node
    ops.node(4016, 11.6, 13.2, 12.6, '-mass', 9.29717125382263, 9.29717125382263, 9.29717125382263, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 11.35, 13.2, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 28568.25895)
    ops.uniaxialMaterial('Elastic', 404016, 28729.56445)
    ...
    # Central joint node
    ops.node(4017, 0.0, 17.6, 12.6, '-mass', 6.358460754332314, 6.358460754332314, 6.358460754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34017, 0.175, 17.6, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304017, 24516.17505)
    ops.uniaxialMaterial('Elastic', 404017, 20558.7264)
    ...
    # Central joint node
    ops.node(4018, 3.1, 17.6, 12.6, '-mass', 14.936060142711518, 14.936060142711518, 14.936060142711518, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 2.825, 17.6, 12.6)
    ops.element('elasticBeamColumn', 54018, 54018, 4018, 99999, 88888)
    ops.node(34018, 3.375, 17.6, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304018, 38195.4743)
    ops.uniaxialMaterial('Elastic', 404018, 34869.9362)
    ...
    # Central joint node
    ops.node(4019, 7.35, 17.6, 12.6, '-mass', 18.077064220183487, 18.077064220183487, 18.077064220183487, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54019, 7.025, 17.6, 12.6)
    ops.element('elasticBeamColumn', 54019, 54019, 4019, 99999, 88888)
    ops.node(34019, 7.675, 17.6, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304019, 52532.25155)
    ops.uniaxialMaterial('Elastic', 404019, 49875.6754)
    ...
    # Central joint node
    ops.node(4020, 11.6, 17.6, 12.6, '-mass', 9.29717125382263, 9.29717125382263, 9.29717125382263, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54020, 11.35, 17.6, 12.6)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304020, 28568.25895)
    ops.uniaxialMaterial('Elastic', 404020, 28729.56445)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304021, 16391.6081)
    ops.uniaxialMaterial('Elastic', 404021, 13660.3222)
    ...
    # Central joint node
    ops.node(4022, 3.1, 22.0, 12.6, '-mass', 7.810002548419979, 7.810002548419979, 7.810002548419979, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64022, 3.1, 21.825, 12.6)
    ops.element('elasticBeamColumn', 64022, 64022, 4022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304022, 30843.78295)
    ops.uniaxialMaterial('Elastic', 404022, 23281.95975)
    ...
    # Central joint node
    ops.node(4023, 7.35, 22.0, 12.6, '-mass', 9.586467889908254, 9.586467889908254, 9.586467889908254, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54023, 7.175, 22.0, 12.6)
    ops.element('elasticBeamColumn', 54023, 54023, 4023, 99999, 88888)
    ops.node(34023, 7.525, 22.0, 12.6)
    ...
    ops.node(64023, 7.35, 21.75, 12.6)
    ops.element('elasticBeamColumn', 64023, 64023, 4023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304023, 48522.4376)
    ops.uniaxialMaterial('Elastic', 404023, 33325.0361)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304024, 18720.04685)
    ops.uniaxialMaterial('Elastic', 404024, 15664.90895)
