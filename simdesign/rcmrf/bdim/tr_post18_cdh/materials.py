"""
Pydantic models for defining materials in tr_post18_cdh buildings.
"""
...
class Steel(SteelBase):
    """Pydantic model representing steel materials
...
class Concrete(ConcreteBase):
    """Pydantic model representing concrete materials for design class
    tr_post18_cdh.
