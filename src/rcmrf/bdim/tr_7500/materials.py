"""
Pydantic models for defining materials in tr_7500 buildings.
"""
...
class Steel(SteelBase):
    """Pydantic model representing steel materials for design class tr_7500.
...
class Concrete(ConcreteBase):
    """Pydantic model representing concrete materials for design class tr_7500.
