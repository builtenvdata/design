"""
Specific routines for defining and designing tr_0018_cdm beams.
...
# Imports from the design class (tr_0018_cdm) library
...
class Beam(BeamBase):
    """Beam object for design class: tr_0018_cdm."""
    ...
    def compute_required_transverse_reinforcement(self) -> None:
        ...
        start, mid, end.
        """
        # Design shear forces due to gravity and earthquake loads
        Vd = np.array(
        ...
        # Section 7.8.5 in TBEC-1998 and Section 3.8.5 in TBEC-2007
        ...
        # Vd > Vcr case
        shear_force_for_reinforcement = Vd - Vc
