"""
Specific routines for defining and designing tr_0018_cdh columns.
...
class Column(ColumnBase):
    """Column object for design class: tr_0018_cdh."""
    ...
    def verify_section_adequacy(self) -> None:
        ...
        # Maximum shear force
        if self.Ve_x is not None and self.Ve_y is not None:
            max_Vx = self.Ve_x
            max_Vy = self.Ve_y
        else:
    ...
    def compute_required_transverse_reinforcement(self) -> None:
        ...
        # (Vx1, Vy1, Vx9, Vy9 are calculated in building.py)
