"""
The model used for detailing the structural members of tr_post18_cdm buildings.
"""
...
class Rebars(RebarsBase):
    """The class used for determining rebar solutions tr_post18_cdm beams
    and columns.
    ...
    def _get_col_max_sbh(self, **kwargs) -> float | np.ndarray:
        ...
        dbl = kwargs["dbl"]  # long. reinf. diameter
        max_sbh = np.minimum(np.minimum(150 * mm, bmin / 3), 8 * dbl)
        return max_sbh
