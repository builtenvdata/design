"""
Pydantic models for defining loads in eu_cdm buildings.
"""
...
class Variable(VariableBase):
    """
    Model representing live loads (Q) for design class eu_cdm.
...
class Permanent(PermanentBase):
    """
    Model representing superimposed dead loads (G) for design class eu_cdm.
...
class Combination(CombinationBase):
    """
    Model representing a load combination for design class eu_cdm.
...
class DataFormat(DataFormatBase):
    """
    Model representing the format of loads data for design class eu_cdm.
