"""
Pydantic models for defining loads in tr_0018_cdh buildings.
"""
...
class Variable(VariableBase):
    """
    Model representing live loads (Q) for design class tr_0018_cdh.
...
class Combination(CombinationBase):
    """
    Model representing a load combination for design class tr_0018_cdh.
...
class LoadsData(LoadsDataBase):
    """
    Model representing the format of loads data for design class tr_0018_cdh.
