...
from src.rcmrf.bcim.parametrization import InputData  # noqa
from src.rcmrf.bcim.parametrization import ArchetypeData  # noqa
...
def all_json_data() -> dict:
    ...
    data_path = data_path / 'src' / 'rcmrf' / 'bcim' / 'data'
