"""
The model used for detailing the structural members of tr_0018_cdm buildings.
"""
...
class Rebars(RebarsBase):
    """The class used for determining rebar solutions tr_0018_cdm beams
    and columns.
    ...
    def _get_min_col_dbh(self, **kwargs) -> float | np.ndarray:
        ...
        References
        ----------
        Section-7.4.1 in TS500
        Section-7.3.4 in TBEC1998
        Section-3.3.4 in TBEC2007
    ...
    def _get_beam_max_sbh(self, **kwargs) -> float | np.ndarray:
        ...
        References
        ----------
        Section 7.8.4 in TBEC-1998
        Section 3.8.4 in TBEC-2007
