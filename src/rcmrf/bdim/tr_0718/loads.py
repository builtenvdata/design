"""
Pydantic models for defining loads in tr_0718 buildings.
"""
...
class Variable(VariableBase):
    """
    Model representing live loads (Q) for design class tr_0718.
...
class Permanent(PermanentBase):
    """
    Model representing superimposed dead loads (G) for design class tr_0718.
...
class Combination(CombinationBase):
    """
    Model representing a load combination for design class tr_0718.
...
class DataFormat(DataFormatBase):
    """
    Model representing the format of loads data for design class tr_0718.
