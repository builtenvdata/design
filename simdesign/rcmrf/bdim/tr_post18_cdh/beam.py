"""
Specific routines for defining and designing tr_post18_cdh beams.
...
class Beam(BeamBase):
    """Beam object for design class: tr_post18_cdh."""
    ...
    def verify_section_adequacy(self) -> None:
        ...
        if self.Ve1 is not None and self.Ve9 is not None:
            Vmax = max(self.Ve1, self.Ve9, self.envelope_forces.V1,
                       self.envelope_forces.V5, self.envelope_forces.V9)
        else:
            Vmax = max(
