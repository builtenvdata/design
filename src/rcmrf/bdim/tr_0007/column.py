"""
Specific routines for defining and designing tr_0007 columns.
...
class Column(ColumnBase):
    """Column object for design class: tr_0007."""
    ...
    def compute_required_transverse_reinforcement(self) -> None:
        ...
        # Transverse reinforcement computation, Section 7.3.7 in TBEC-1998
        if Ve_x <= Vcr_x:
