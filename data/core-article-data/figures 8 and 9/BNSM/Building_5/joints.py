...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(1003, 8.3, 0.0, 3.7, '-mass', 8.616501899043369, 8.616501899043369, 8.616501899043369, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1004, 11.25, 0.0, 3.7, '-mass', 8.616501899043369, 8.616501899043369, 8.616501899043369, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 11.075, 0.0, 3.7)
    ops.element('elasticBeamColumn', 51004, 51004, 1004, 99999, 88888)
    ops.node(31004, 11.425, 0.0, 3.7)
    ops.element('elasticBeamColumn', 31004, 1004, 31004, 99999, 88888)
    ops.node(21004, 11.25, 0.0, 3.5)
    ops.element('elasticBeamColumn', 21004, 21004, 1004, 99999, 99999)
    ops.node(71004, 11.25, 0.0, 3.9)
    ops.element('elasticBeamColumn', 71004, 1004, 71004, 99999, 99999)
    ops.node(41004, 11.25, 0.175, 3.7)
    ...
    # Central joint node
    ops.node(2003, 8.3, 0.0, 6.8, '-mass', 8.284085996902695, 8.284085996902695, 8.284085996902695, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2004, 11.25, 0.0, 6.8, '-mass', 8.284085996902695, 8.284085996902695, 8.284085996902695, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 11.075, 0.0, 6.8)
    ops.element('elasticBeamColumn', 52004, 52004, 2004, 99999, 88888)
    ops.node(32004, 11.425, 0.0, 6.8)
    ops.element('elasticBeamColumn', 32004, 2004, 32004, 99999, 88888)
    ops.node(22004, 11.25, 0.0, 6.625)
    ops.element('elasticBeamColumn', 22004, 22004, 2004, 99999, 99999)
    ops.node(72004, 11.25, 0.0, 6.975)
    ops.element('elasticBeamColumn', 72004, 2004, 72004, 99999, 99999)
    ops.node(42004, 11.25, 0.175, 6.8)
    ...
    # Central joint node
    ops.node(2007, 0.0, 4.85, 6.8, '-mass', 11.881525714498563, 11.881525714498563, 11.881525714498563, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32007, 0.175, 4.85, 6.8)
    ops.element('elasticBeamColumn', 32007, 2007, 32007, 99999, 88888)
    ops.node(22007, 0.0, 4.85, 6.55)
    ops.element('elasticBeamColumn', 22007, 22007, 2007, 99999, 99999)
    ops.node(72007, 0.0, 4.85, 7.05)
    ops.element('elasticBeamColumn', 72007, 2007, 72007, 99999, 99999)
    ops.node(62007, 0.0, 4.675, 6.8)
    ops.element('elasticBeamColumn', 62007, 62007, 2007, 99999, 77777)
    ops.node(42007, 0.0, 5.025, 6.8)
    ...
    # Central joint node
    ops.node(2012, 19.55, 4.85, 6.8, '-mass', 11.881525714498563, 11.881525714498563, 11.881525714498563, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 19.375, 4.85, 6.8)
    ops.element('elasticBeamColumn', 52012, 52012, 2012, 99999, 88888)
    ops.node(22012, 19.55, 4.85, 6.55)
    ops.element('elasticBeamColumn', 22012, 22012, 2012, 99999, 99999)
    ops.node(72012, 19.55, 4.85, 7.05)
    ops.element('elasticBeamColumn', 72012, 2012, 72012, 99999, 99999)
    ops.node(62012, 19.55, 4.675, 6.8)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 19.55, 5.025, 6.8)
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 9.9, '-mass', 7.582709850113705, 7.582709850113705, 7.582709850113705, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3002, 4.15, 0.0, 9.9, '-mass', 10.934023166078585, 10.934023166078585, 10.934023166078585, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53002, 4.025, 0.0, 9.9)
    ops.element('elasticBeamColumn', 53002, 53002, 3002, 99999, 88888)
    ops.node(33002, 4.275, 0.0, 9.9)
    ops.element('elasticBeamColumn', 33002, 3002, 33002, 99999, 88888)
    ops.node(23002, 4.15, 0.0, 9.7)
    ops.element('elasticBeamColumn', 23002, 23002, 3002, 99999, 99999)
    ops.node(73002, 4.15, 0.0, 10.1)
    ops.element('elasticBeamColumn', 73002, 3002, 73002, 99999, 99999)
    ops.node(43002, 4.15, 0.125, 9.9)
    ...
    # Central joint node
    ops.node(3003, 8.3, 0.0, 9.9, '-mass', 8.007174681917986, 8.007174681917986, 8.007174681917986, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3004, 11.25, 0.0, 9.9, '-mass', 8.007174681917986, 8.007174681917986, 8.007174681917986, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53004, 11.125, 0.0, 9.9)
    ops.element('elasticBeamColumn', 53004, 53004, 3004, 99999, 88888)
    ops.node(33004, 11.375, 0.0, 9.9)
    ops.element('elasticBeamColumn', 33004, 3004, 33004, 99999, 88888)
    ops.node(23004, 11.25, 0.0, 9.7)
    ops.element('elasticBeamColumn', 23004, 23004, 3004, 99999, 99999)
    ops.node(73004, 11.25, 0.0, 10.1)
    ops.element('elasticBeamColumn', 73004, 3004, 73004, 99999, 99999)
    ops.node(43004, 11.25, 0.125, 9.9)
    ...
    # Central joint node
    ops.node(3005, 15.4, 0.0, 9.9, '-mass', 10.934023166078585, 10.934023166078585, 10.934023166078585, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53005, 15.275, 0.0, 9.9)
    ops.element('elasticBeamColumn', 53005, 53005, 3005, 99999, 88888)
    ops.node(33005, 15.525, 0.0, 9.9)
    ops.element('elasticBeamColumn', 33005, 3005, 33005, 99999, 88888)
    ops.node(23005, 15.4, 0.0, 9.7)
    ops.element('elasticBeamColumn', 23005, 23005, 3005, 99999, 99999)
    ops.node(73005, 15.4, 0.0, 10.1)
    ops.element('elasticBeamColumn', 73005, 3005, 73005, 99999, 99999)
    ops.node(43005, 15.4, 0.125, 9.9)
    ...
    # Central joint node
    ops.node(3006, 19.55, 0.0, 9.9, '-mass', 7.582709850113705, 7.582709850113705, 7.582709850113705, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53006, 19.425, 0.0, 9.9)
    ops.element('elasticBeamColumn', 53006, 53006, 3006, 99999, 88888)
    ops.node(23006, 19.55, 0.0, 9.65)
    ops.element('elasticBeamColumn', 23006, 23006, 3006, 99999, 99999)
    ops.node(73006, 19.55, 0.0, 10.15)
    ops.element('elasticBeamColumn', 73006, 3006, 73006, 99999, 99999)
    ops.node(43006, 19.55, 0.125, 9.9)
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.85, 9.9, '-mass', 11.654002778718748, 11.654002778718748, 11.654002778718748, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33007, 0.125, 4.85, 9.9)
    ops.element('elasticBeamColumn', 33007, 3007, 33007, 99999, 88888)
    ops.node(23007, 0.0, 4.85, 9.65)
    ops.element('elasticBeamColumn', 23007, 23007, 3007, 99999, 99999)
    ops.node(73007, 0.0, 4.85, 10.15)
    ops.element('elasticBeamColumn', 73007, 3007, 73007, 99999, 99999)
    ops.node(63007, 0.0, 4.725, 9.9)
    ops.element('elasticBeamColumn', 63007, 63007, 3007, 99999, 77777)
    ops.node(43007, 0.0, 4.975, 9.9)
    ...
    # Central joint node
    ops.node(3012, 19.55, 4.85, 9.9, '-mass', 11.654002778718748, 11.654002778718748, 11.654002778718748, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 19.425, 4.85, 9.9)
    ops.element('elasticBeamColumn', 53012, 53012, 3012, 99999, 88888)
    ops.node(23012, 19.55, 4.85, 9.65)
    ops.element('elasticBeamColumn', 23012, 23012, 3012, 99999, 99999)
    ops.node(73012, 19.55, 4.85, 10.15)
    ops.element('elasticBeamColumn', 73012, 3012, 73012, 99999, 99999)
    ops.node(63012, 19.55, 4.725, 9.9)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    ops.node(43012, 19.55, 4.975, 9.9)
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.7, 9.9, '-mass', 7.582709850113705, 7.582709850113705, 7.582709850113705, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33013, 0.125, 9.7, 9.9)
    ops.element('elasticBeamColumn', 33013, 3013, 33013, 99999, 88888)
    ops.node(23013, 0.0, 9.7, 9.65)
    ops.element('elasticBeamColumn', 23013, 23013, 3013, 99999, 99999)
    ops.node(73013, 0.0, 9.7, 10.15)
    ops.element('elasticBeamColumn', 73013, 3013, 73013, 99999, 99999)
    ops.node(63013, 0.0, 9.575, 9.9)
    ...
    # Central joint node
    ops.node(3014, 4.15, 9.7, 9.9, '-mass', 10.934023166078585, 10.934023166078585, 10.934023166078585, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53014, 4.025, 9.7, 9.9)
    ops.element('elasticBeamColumn', 53014, 53014, 3014, 99999, 88888)
    ops.node(33014, 4.275, 9.7, 9.9)
    ops.element('elasticBeamColumn', 33014, 3014, 33014, 99999, 88888)
    ops.node(23014, 4.15, 9.7, 9.7)
    ops.element('elasticBeamColumn', 23014, 23014, 3014, 99999, 99999)
    ops.node(73014, 4.15, 9.7, 10.1)
    ops.element('elasticBeamColumn', 73014, 3014, 73014, 99999, 99999)
    ops.node(63014, 4.15, 9.575, 9.9)
    ...
    # Central joint node
    ops.node(3016, 11.25, 9.7, 9.9, '-mass', 9.41428476235444, 9.41428476235444, 9.41428476235444, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53016, 11.125, 9.7, 9.9)
    ops.element('elasticBeamColumn', 53016, 53016, 3016, 99999, 88888)
    ops.node(33016, 11.375, 9.7, 9.9)
    ops.element('elasticBeamColumn', 33016, 3016, 33016, 99999, 88888)
    ops.node(23016, 11.25, 9.7, 9.7)
    ops.element('elasticBeamColumn', 23016, 23016, 3016, 99999, 99999)
    ops.node(73016, 11.25, 9.7, 10.1)
    ops.element('elasticBeamColumn', 73016, 3016, 73016, 99999, 99999)
    ops.node(63016, 11.25, 9.575, 9.9)
    ...
    # Central joint node
    ops.node(3017, 15.4, 9.7, 9.9, '-mass', 10.934023166078585, 10.934023166078585, 10.934023166078585, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53017, 15.275, 9.7, 9.9)
    ops.element('elasticBeamColumn', 53017, 53017, 3017, 99999, 88888)
    ops.node(33017, 15.525, 9.7, 9.9)
    ops.element('elasticBeamColumn', 33017, 3017, 33017, 99999, 88888)
    ops.node(23017, 15.4, 9.7, 9.7)
    ops.element('elasticBeamColumn', 23017, 23017, 3017, 99999, 99999)
    ops.node(73017, 15.4, 9.7, 10.1)
    ops.element('elasticBeamColumn', 73017, 3017, 73017, 99999, 99999)
    ops.node(63017, 15.4, 9.575, 9.9)
    ...
    # Central joint node
    ops.node(3018, 19.55, 9.7, 9.9, '-mass', 7.582709850113705, 7.582709850113705, 7.582709850113705, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 19.425, 9.7, 9.9)
    ops.element('elasticBeamColumn', 53018, 53018, 3018, 99999, 88888)
    ops.node(23018, 19.55, 9.7, 9.65)
    ops.element('elasticBeamColumn', 23018, 23018, 3018, 99999, 99999)
    ops.node(73018, 19.55, 9.7, 10.15)
    ops.element('elasticBeamColumn', 73018, 3018, 73018, 99999, 99999)
    ops.node(63018, 19.55, 9.575, 9.9)
    ...
    # Central joint node
    ops.node(4001, 0.0, 0.0, 13.0, '-mass', 3.5599652017956633, 3.5599652017956633, 3.5599652017956633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4002, 4.15, 0.0, 13.0, '-mass', 6.971918171175425, 6.971918171175425, 6.971918171175425, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54002, 4.025, 0.0, 13.0)
    ops.element('elasticBeamColumn', 54002, 54002, 4002, 99999, 88888)
    ops.node(34002, 4.275, 0.0, 13.0)
    ops.element('elasticBeamColumn', 34002, 4002, 34002, 99999, 88888)
    ops.node(24002, 4.15, 0.0, 12.825)
    ops.element('elasticBeamColumn', 24002, 24002, 4002, 99999, 99999)
    ops.node(44002, 4.15, 0.125, 13.0)
    ...
    # Central joint node
    ops.node(4003, 8.3, 0.0, 13.0, '-mass', 4.2215859969026965, 4.2215859969026965, 4.2215859969026965, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4004, 11.25, 0.0, 13.0, '-mass', 4.2215859969026965, 4.2215859969026965, 4.2215859969026965, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54004, 11.125, 0.0, 13.0)
    ops.element('elasticBeamColumn', 54004, 54004, 4004, 99999, 88888)
    ops.node(34004, 11.375, 0.0, 13.0)
    ops.element('elasticBeamColumn', 34004, 4004, 34004, 99999, 88888)
    ops.node(24004, 11.25, 0.0, 12.825)
    ops.element('elasticBeamColumn', 24004, 24004, 4004, 99999, 99999)
    ops.node(44004, 11.25, 0.125, 13.0)
    ...
    # Central joint node
    ops.node(4005, 15.4, 0.0, 13.0, '-mass', 6.971918171175425, 6.971918171175425, 6.971918171175425, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54005, 15.275, 0.0, 13.0)
    ops.element('elasticBeamColumn', 54005, 54005, 4005, 99999, 88888)
    ops.node(34005, 15.525, 0.0, 13.0)
    ops.element('elasticBeamColumn', 34005, 4005, 34005, 99999, 88888)
    ops.node(24005, 15.4, 0.0, 12.825)
    ops.element('elasticBeamColumn', 24005, 24005, 4005, 99999, 99999)
    ops.node(44005, 15.4, 0.125, 13.0)
    ...
    # Central joint node
    ops.node(4006, 19.55, 0.0, 13.0, '-mass', 3.5599652017956633, 3.5599652017956633, 3.5599652017956633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54006, 19.425, 0.0, 13.0)
    ops.element('elasticBeamColumn', 54006, 54006, 4006, 99999, 88888)
    ops.node(24006, 19.55, 0.0, 12.8)
    ops.element('elasticBeamColumn', 24006, 24006, 4006, 99999, 99999)
    ops.node(44006, 19.55, 0.125, 13.0)
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.85, 13.0, '-mass', 6.806780556496525, 6.806780556496525, 6.806780556496525, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34007, 0.125, 4.85, 13.0)
    ops.element('elasticBeamColumn', 34007, 4007, 34007, 99999, 88888)
    ops.node(24007, 0.0, 4.85, 12.8)
    ops.element('elasticBeamColumn', 24007, 24007, 4007, 99999, 99999)
    ops.node(64007, 0.0, 4.725, 13.0)
    ops.element('elasticBeamColumn', 64007, 64007, 4007, 99999, 77777)
    ops.node(44007, 0.0, 4.975, 13.0)
    ...
    # Central joint node
    ops.node(4012, 19.55, 4.85, 13.0, '-mass', 6.806780556496525, 6.806780556496525, 6.806780556496525, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 19.425, 4.85, 13.0)
    ops.element('elasticBeamColumn', 54012, 54012, 4012, 99999, 88888)
    ops.node(24012, 19.55, 4.85, 12.8)
    ops.element('elasticBeamColumn', 24012, 24012, 4012, 99999, 99999)
    ops.node(64012, 19.55, 4.725, 13.0)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 19.55, 4.975, 13.0)
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.7, 13.0, '-mass', 3.5599652017956633, 3.5599652017956633, 3.5599652017956633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 0.125, 9.7, 13.0)
    ops.element('elasticBeamColumn', 34013, 4013, 34013, 99999, 88888)
    ops.node(24013, 0.0, 9.7, 12.8)
    ops.element('elasticBeamColumn', 24013, 24013, 4013, 99999, 99999)
    ops.node(64013, 0.0, 9.575, 13.0)
    ...
    # Central joint node
    ops.node(4014, 4.15, 9.7, 13.0, '-mass', 6.971918171175425, 6.971918171175425, 6.971918171175425, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 4.025, 9.7, 13.0)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 4.275, 9.7, 13.0)
    ops.element('elasticBeamColumn', 34014, 4014, 34014, 99999, 88888)
    ops.node(24014, 4.15, 9.7, 12.825)
    ops.element('elasticBeamColumn', 24014, 24014, 4014, 99999, 99999)
    ops.node(64014, 4.15, 9.575, 13.0)
    ...
    # Central joint node
    ops.node(4015, 8.3, 9.7, 13.0, '-mass', 5.969305149714274, 5.969305149714274, 5.969305149714274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 8.175, 9.7, 13.0)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 8.425, 9.7, 13.0)
    ops.element('elasticBeamColumn', 34015, 4015, 34015, 99999, 88888)
    ops.node(24015, 8.3, 9.7, 12.825)
    ops.element('elasticBeamColumn', 24015, 24015, 4015, 99999, 99999)
    ops.node(64015, 8.3, 9.575, 13.0)
    ...
    # Central joint node
    ops.node(4016, 11.25, 9.7, 13.0, '-mass', 5.969305149714274, 5.969305149714274, 5.969305149714274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 11.125, 9.7, 13.0)
    ops.element('elasticBeamColumn', 54016, 54016, 4016, 99999, 88888)
    ops.node(34016, 11.375, 9.7, 13.0)
    ops.element('elasticBeamColumn', 34016, 4016, 34016, 99999, 88888)
    ops.node(24016, 11.25, 9.7, 12.825)
    ops.element('elasticBeamColumn', 24016, 24016, 4016, 99999, 99999)
    ops.node(64016, 11.25, 9.575, 13.0)
    ...
    # Central joint node
    ops.node(4017, 15.4, 9.7, 13.0, '-mass', 6.971918171175425, 6.971918171175425, 6.971918171175425, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54017, 15.275, 9.7, 13.0)
    ops.element('elasticBeamColumn', 54017, 54017, 4017, 99999, 88888)
    ops.node(34017, 15.525, 9.7, 13.0)
    ops.element('elasticBeamColumn', 34017, 4017, 34017, 99999, 88888)
    ops.node(24017, 15.4, 9.7, 12.825)
    ops.element('elasticBeamColumn', 24017, 24017, 4017, 99999, 99999)
    ops.node(64017, 15.4, 9.575, 13.0)
    ...
    # Central joint node
    ops.node(4018, 19.55, 9.7, 13.0, '-mass', 3.5599652017956633, 3.5599652017956633, 3.5599652017956633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 19.425, 9.7, 13.0)
    ops.element('elasticBeamColumn', 54018, 54018, 4018, 99999, 88888)
    ops.node(24018, 19.55, 9.7, 12.8)
    ops.element('elasticBeamColumn', 24018, 24018, 4018, 99999, 99999)
    ops.node(64018, 19.55, 9.575, 13.0)
