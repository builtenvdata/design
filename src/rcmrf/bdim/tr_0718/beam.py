"""
Specific routines for defining and designing tr_0718 beams.
...
class Beam(BeamBase):
    """Beam object for design class: tr_0718."""
    ...
    """The default minimum breadth (width) of emergent beams.TBEC-2007"""
    ...
    def verify_section_adequacy(self) -> None:
        ...
        Vrd_max = 0.22 * self.b * d * self.fcd  # Eq. 8.7 in TS500-2000
    ...
    def _get_long_area(self, Md: Array3
        ...
        Mr1 = 0.235 * fcd * bw * (d**2) * (1 - 0.1175 / 0.85)
        ...
        if np.any(mask):  # Single reinforcement
            K = Md[mask] / (bw * d**2)
            rho = 0.85 * (fcd / fyd) * (1 - (1 - (2 * K) / (0.85 * fcd))
                                        ** 0.5)
            ...
            epss_prime = 0.003 * (1 - (self.k1 * 0.85 / 0.235) * (dprime / d))
    ...
    def compute_required_transverse_reinforcement(self) -> None:
        ...
        # Transverse reinforcement computation, Section 3.4.5 in TBEC-2007
