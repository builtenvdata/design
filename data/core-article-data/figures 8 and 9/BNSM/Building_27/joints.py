...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4017, 5.05, 0.0, 1.4, '-mass', 3.462793068297657, 3.462793068297657, 3.462793068297657, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4018, 7.95, 0.0, 1.4, '-mass', 3.462793068297657, 3.462793068297657, 3.462793068297657, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 2.8, '-mass', 11.260346585117226, 11.260346585117226, 11.260346585117226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31001, 0.175, 0.0, 2.8)
    ...
    ops.node(41001, 0.0, 0.175, 2.8)
    ops.element('elasticBeamColumn', 41001, 1001, 41001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301001, 45283.3859)
    ops.uniaxialMaterial('Elastic', 401001, 66933.96365)
    ...
    # Central joint node
    ops.node(1002, 5.05, 0.0, 2.8, '-mass', 11.68909276248726, 11.68909276248726, 11.68909276248726, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 95225.5798)
    ops.uniaxialMaterial('Elastic', 401002, 152973.7604)
    ...
    # Central joint node
    ops.node(1003, 7.95, 0.0, 2.8, '-mass', 11.68909276248726, 11.68909276248726, 11.68909276248726, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 95225.5798)
    ops.uniaxialMaterial('Elastic', 401003, 152973.7604)
    ...
    # Central joint node
    ops.node(1004, 13.0, 0.0, 2.8, '-mass', 11.260346585117226, 11.260346585117226, 11.260346585117226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 12.825, 0.0, 2.8)
    ...
    ops.node(41004, 13.0, 0.175, 2.8)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 45283.3859)
    ops.uniaxialMaterial('Elastic', 401004, 66933.96365)
    ...
    # Central joint node
    ops.node(1005, 0.0, 4.4, 2.8, '-mass', 17.699490316004077, 17.699490316004077, 17.699490316004077, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.225, 4.4, 2.8)
    ...
    ops.node(61005, 0.0, 4.175, 2.8)
    ops.element('elasticBeamColumn', 61005, 61005, 1005, 99999, 77777)
    ops.node(41005, 0.0, 4.625, 2.8)
    ops.element('elasticBeamColumn', 41005, 1005, 41005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 108010.4066)
    ops.uniaxialMaterial('Elastic', 401005, 124292.33625)
    ...
    # Central joint node
    ops.node(1006, 5.05, 4.4, 2.8, '-mass', 22.192329255861367, 22.192329255861367, 22.192329255861367, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 171686.5061)
    ops.uniaxialMaterial('Elastic', 401006, 213235.5309)
    ...
    # Central joint node
    ops.node(1007, 7.95, 4.4, 2.8, '-mass', 22.192329255861367, 22.192329255861367, 22.192329255861367, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 171686.5061)
    ops.uniaxialMaterial('Elastic', 401007, 213235.5309)
    ...
    # Central joint node
    ops.node(1008, 13.0, 4.4, 2.8, '-mass', 17.699490316004077, 17.699490316004077, 17.699490316004077, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 12.775, 4.4, 2.8)
    ...
    ops.node(61008, 13.0, 4.175, 2.8)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 13.0, 4.625, 2.8)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 108010.4066)
    ops.uniaxialMaterial('Elastic', 401008, 124292.33625)
    ...
    # Central joint node
    ops.node(1009, 0.0, 8.8, 2.8, '-mass', 17.699490316004077, 17.699490316004077, 17.699490316004077, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31009, 0.225, 8.8, 2.8)
    ...
    ops.node(61009, 0.0, 8.575, 2.8)
    ops.element('elasticBeamColumn', 61009, 61009, 1009, 99999, 77777)
    ops.node(41009, 0.0, 9.025, 2.8)
    ops.element('elasticBeamColumn', 41009, 1009, 41009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 108010.4066)
    ops.uniaxialMaterial('Elastic', 401009, 124292.33625)
    ...
    # Central joint node
    ops.node(1010, 5.05, 8.8, 2.8, '-mass', 21.224821610601424, 21.224821610601424, 21.224821610601424, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 4.8, 8.8, 2.8)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 5.3, 8.8, 2.8)
    ...
    ops.node(61010, 5.05, 8.55, 2.8)
    ops.element('elasticBeamColumn', 61010, 61010, 1010, 99999, 77777)
    ops.node(41010, 5.05, 9.05, 2.8)
    ops.element('elasticBeamColumn', 41010, 1010, 41010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 168718.00445)
    ops.uniaxialMaterial('Elastic', 401010, 209548.6365)
    ...
    # Central joint node
    ops.node(1011, 7.95, 8.8, 2.8, '-mass', 21.224821610601424, 21.224821610601424, 21.224821610601424, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 7.7, 8.8, 2.8)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 8.2, 8.8, 2.8)
    ...
    ops.node(61011, 7.95, 8.55, 2.8)
    ops.element('elasticBeamColumn', 61011, 61011, 1011, 99999, 77777)
    ops.node(41011, 7.95, 9.05, 2.8)
    ops.element('elasticBeamColumn', 41011, 1011, 41011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 168718.00445)
    ops.uniaxialMaterial('Elastic', 401011, 209548.6365)
    ...
    # Central joint node
    ops.node(1012, 13.0, 8.8, 2.8, '-mass', 17.699490316004077, 17.699490316004077, 17.699490316004077, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 12.775, 8.8, 2.8)
    ...
    ops.node(61012, 13.0, 8.575, 2.8)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 13.0, 9.025, 2.8)
    ops.element('elasticBeamColumn', 41012, 1012, 41012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 108010.4066)
    ops.uniaxialMaterial('Elastic', 401012, 124292.33625)
    ...
    # Central joint node
    ops.node(1013, 0.0, 13.2, 2.8, '-mass', 11.260346585117226, 11.260346585117226, 11.260346585117226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.175, 13.2, 2.8)
    ...
    ops.node(61013, 0.0, 13.025, 2.8)
    ops.element('elasticBeamColumn', 61013, 61013, 1013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 45283.3859)
    ops.uniaxialMaterial('Elastic', 401013, 66933.96365)
    ...
    # Central joint node
    ops.node(1014, 5.05, 13.2, 2.8, '-mass', 14.417915392456674, 14.417915392456674, 14.417915392456674, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 4.85, 13.2, 2.8)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 5.25, 13.2, 2.8)
    ...
    ops.node(61014, 5.05, 13.0, 2.8)
    ops.element('elasticBeamColumn', 61014, 61014, 1014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 79581.81755)
    ops.uniaxialMaterial('Elastic', 401014, 124787.674)
    ...
    # Central joint node
    ops.node(1015, 7.95, 13.2, 2.8, '-mass', 14.417915392456674, 14.417915392456674, 14.417915392456674, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 7.75, 13.2, 2.8)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 8.15, 13.2, 2.8)
    ...
    ops.node(61015, 7.95, 13.0, 2.8)
    ops.element('elasticBeamColumn', 61015, 61015, 1015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 79581.81755)
    ops.uniaxialMaterial('Elastic', 401015, 124787.674)
    ...
    # Central joint node
    ops.node(1016, 13.0, 13.2, 2.8, '-mass', 11.260346585117226, 11.260346585117226, 11.260346585117226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 12.825, 13.2, 2.8)
    ...
    ops.node(61016, 13.0, 13.025, 2.8)
    ops.element('elasticBeamColumn', 61016, 61016, 1016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 45283.3859)
    ops.uniaxialMaterial('Elastic', 401016, 66933.96365)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.6, '-mass', 11.054841997961264, 11.054841997961264, 11.054841997961264, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32001, 0.175, 0.0, 5.6)
    ...
    ops.node(42001, 0.0, 0.175, 5.6)
    ops.element('elasticBeamColumn', 42001, 2001, 42001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 38886.3306)
    ops.uniaxialMaterial('Elastic', 402001, 57700.7561)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 81579.73195)
    ops.uniaxialMaterial('Elastic', 402002, 129889.563)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 81579.73195)
    ops.uniaxialMaterial('Elastic', 402003, 129889.563)
    ...
    # Central joint node
    ops.node(2004, 13.0, 0.0, 5.6, '-mass', 11.054841997961264, 11.054841997961264, 11.054841997961264, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 12.825, 0.0, 5.6)
    ...
    ops.node(42004, 13.0, 0.175, 5.6)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 38886.3306)
    ops.uniaxialMaterial('Elastic', 402004, 57700.7561)
    ...
    # Central joint node
    ops.node(2005, 0.0, 4.4, 5.6, '-mass', 17.425484199796127, 17.425484199796127, 17.425484199796127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.225, 4.4, 5.6)
    ...
    ops.node(62005, 0.0, 4.175, 5.6)
    ops.element('elasticBeamColumn', 62005, 62005, 2005, 99999, 77777)
    ops.node(42005, 0.0, 4.625, 5.6)
    ops.element('elasticBeamColumn', 42005, 2005, 42005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 92305.79525)
    ops.uniaxialMaterial('Elastic', 402005, 107211.78815)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 147848.48195)
    ops.uniaxialMaterial('Elastic', 402006, 183628.5813)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 147848.48195)
    ops.uniaxialMaterial('Elastic', 402007, 183628.5813)
    ...
    # Central joint node
    ops.node(2008, 13.0, 4.4, 5.6, '-mass', 17.425484199796127, 17.425484199796127, 17.425484199796127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 12.775, 4.4, 5.6)
    ...
    ops.node(62008, 13.0, 4.175, 5.6)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 13.0, 4.625, 5.6)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 92305.79525)
    ops.uniaxialMaterial('Elastic', 402008, 107211.78815)
    ...
    # Central joint node
    ops.node(2009, 0.0, 8.8, 5.6, '-mass', 17.425484199796127, 17.425484199796127, 17.425484199796127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32009, 0.225, 8.8, 5.6)
    ...
    ops.node(62009, 0.0, 8.575, 5.6)
    ops.element('elasticBeamColumn', 62009, 62009, 2009, 99999, 77777)
    ops.node(42009, 0.0, 9.025, 5.6)
    ops.element('elasticBeamColumn', 42009, 2009, 42009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 92305.79525)
    ops.uniaxialMaterial('Elastic', 402009, 107211.78815)
    ...
    # Central joint node
    ops.node(2010, 5.05, 8.8, 5.6, '-mass', 20.91656472986748, 20.91656472986748, 20.91656472986748, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 4.8, 8.8, 5.6)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 5.3, 8.8, 5.6)
    ...
    ops.node(62010, 5.05, 8.55, 5.6)
    ops.element('elasticBeamColumn', 62010, 62010, 2010, 99999, 77777)
    ops.node(42010, 5.05, 9.05, 5.6)
    ops.element('elasticBeamColumn', 42010, 2010, 42010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 144816.5959)
    ops.uniaxialMaterial('Elastic', 402010, 179862.9631)
    ...
    # Central joint node
    ops.node(2011, 7.95, 8.8, 5.6, '-mass', 20.91656472986748, 20.91656472986748, 20.91656472986748, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 7.7, 8.8, 5.6)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 8.2, 8.8, 5.6)
    ...
    ops.node(62011, 7.95, 8.55, 5.6)
    ops.element('elasticBeamColumn', 62011, 62011, 2011, 99999, 77777)
    ops.node(42011, 7.95, 9.05, 5.6)
    ops.element('elasticBeamColumn', 42011, 2011, 42011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 144816.5959)
    ops.uniaxialMaterial('Elastic', 402011, 179862.9631)
    ...
    # Central joint node
    ops.node(2012, 13.0, 8.8, 5.6, '-mass', 17.425484199796127, 17.425484199796127, 17.425484199796127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 12.775, 8.8, 5.6)
    ...
    ops.node(62012, 13.0, 8.575, 5.6)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 13.0, 9.025, 5.6)
    ops.element('elasticBeamColumn', 42012, 2012, 42012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 92305.79525)
    ops.uniaxialMaterial('Elastic', 402012, 107211.78815)
    ...
    # Central joint node
    ops.node(2013, 0.0, 13.2, 5.6, '-mass', 11.054841997961264, 11.054841997961264, 11.054841997961264, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32013, 0.175, 13.2, 5.6)
    ...
    ops.node(62013, 0.0, 13.025, 5.6)
    ops.element('elasticBeamColumn', 62013, 62013, 2013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 38886.3306)
    ops.uniaxialMaterial('Elastic', 402013, 57700.7561)
    ...
    # Central joint node
    ops.node(2014, 5.05, 13.2, 5.6, '-mass', 14.289475025484197, 14.289475025484197, 14.289475025484197, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 4.85, 13.2, 5.6)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 5.25, 13.2, 5.6)
    ...
    ops.node(62014, 5.05, 13.0, 5.6)
    ops.element('elasticBeamColumn', 62014, 62014, 2014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 68534.6798)
    ops.uniaxialMaterial('Elastic', 402014, 106550.406)
    ...
    # Central joint node
    ops.node(2015, 7.95, 13.2, 5.6, '-mass', 14.289475025484197, 14.289475025484197, 14.289475025484197, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 7.75, 13.2, 5.6)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 8.15, 13.2, 5.6)
    ...
    ops.node(62015, 7.95, 13.0, 5.6)
    ops.element('elasticBeamColumn', 62015, 62015, 2015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 68534.6798)
    ops.uniaxialMaterial('Elastic', 402015, 106550.406)
    ...
    # Central joint node
    ops.node(2016, 13.0, 13.2, 5.6, '-mass', 11.054841997961264, 11.054841997961264, 11.054841997961264, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 12.825, 13.2, 5.6)
    ...
    ops.node(62016, 13.0, 13.025, 5.6)
    ops.element('elasticBeamColumn', 62016, 62016, 2016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 38886.3306)
    ops.uniaxialMaterial('Elastic', 402016, 57700.7561)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 24430.1229)
    ops.uniaxialMaterial('Elastic', 403001, 33015.16455)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 48005.41105)
    ops.uniaxialMaterial('Elastic', 403002, 87486.46945)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 48005.41105)
    ops.uniaxialMaterial('Elastic', 403003, 87486.46945)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 24430.1229)
    ops.uniaxialMaterial('Elastic', 403004, 33015.16455)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 56483.3567)
    ops.uniaxialMaterial('Elastic', 403005, 67019.2277)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 83801.1272)
    ops.uniaxialMaterial('Elastic', 403006, 117601.6395)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 83801.1272)
    ops.uniaxialMaterial('Elastic', 403007, 117601.6395)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 56483.3567)
    ops.uniaxialMaterial('Elastic', 403008, 67019.2277)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 56483.3567)
    ops.uniaxialMaterial('Elastic', 403009, 67019.2277)
    ...
    # Central joint node
    ops.node(3010, 5.05, 8.8, 8.4, '-mass', 20.473751274209988, 20.473751274209988, 20.473751274209988, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53010, 4.85, 8.8, 8.4)
    ops.element('elasticBeamColumn', 53010, 53010, 3010, 99999, 88888)
    ops.node(33010, 5.25, 8.8, 8.4)
    ...
    ops.node(63010, 5.05, 8.6, 8.4)
    ops.element('elasticBeamColumn', 63010, 63010, 3010, 99999, 77777)
    ops.node(43010, 5.05, 9.0, 8.4)
    ops.element('elasticBeamColumn', 43010, 3010, 43010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 81483.44735)
    ops.uniaxialMaterial('Elastic', 403010, 114349.1421)
    ...
    # Central joint node
    ops.node(3011, 7.95, 8.8, 8.4, '-mass', 20.473751274209988, 20.473751274209988, 20.473751274209988, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53011, 7.75, 8.8, 8.4)
    ops.element('elasticBeamColumn', 53011, 53011, 3011, 99999, 88888)
    ops.node(33011, 8.15, 8.8, 8.4)
    ...
    ops.node(63011, 7.95, 8.6, 8.4)
    ops.element('elasticBeamColumn', 63011, 63011, 3011, 99999, 77777)
    ops.node(43011, 7.95, 9.0, 8.4)
    ops.element('elasticBeamColumn', 43011, 3011, 43011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 81483.44735)
    ops.uniaxialMaterial('Elastic', 403011, 114349.1421)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 56483.3567)
    ops.uniaxialMaterial('Elastic', 403012, 67019.2277)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 24430.1229)
    ops.uniaxialMaterial('Elastic', 403013, 33015.16455)
    ...
    # Central joint node
    ops.node(3014, 5.05, 13.2, 8.4, '-mass', 14.093756371049947, 14.093756371049947, 14.093756371049947, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53014, 4.875, 13.2, 8.4)
    ops.element('elasticBeamColumn', 53014, 53014, 3014, 99999, 88888)
    ops.node(33014, 5.225, 13.2, 8.4)
    ...
    ops.node(63014, 5.05, 13.025, 8.4)
    ops.element('elasticBeamColumn', 63014, 63014, 3014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 42200.2819)
    ops.uniaxialMaterial('Elastic', 403014, 73500.60865)
    ...
    # Central joint node
    ops.node(3015, 7.95, 13.2, 8.4, '-mass', 14.093756371049947, 14.093756371049947, 14.093756371049947, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53015, 7.775, 13.2, 8.4)
    ops.element('elasticBeamColumn', 53015, 53015, 3015, 99999, 88888)
    ops.node(33015, 8.125, 13.2, 8.4)
    ...
    ops.node(63015, 7.95, 13.025, 8.4)
    ops.element('elasticBeamColumn', 63015, 63015, 3015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 42200.2819)
    ops.uniaxialMaterial('Elastic', 403015, 73500.60865)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 24430.1229)
    ops.uniaxialMaterial('Elastic', 403016, 33015.16455)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 16253.66735)
    ops.uniaxialMaterial('Elastic', 404001, 22578.2268)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 33258.09845)
    ops.uniaxialMaterial('Elastic', 404002, 33258.09845)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 33258.09845)
    ops.uniaxialMaterial('Elastic', 404003, 33258.09845)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 16253.66735)
    ops.uniaxialMaterial('Elastic', 404004, 22578.2268)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 30671.6187)
    ops.uniaxialMaterial('Elastic', 404005, 54221.57495)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 57429.09415)
    ops.uniaxialMaterial('Elastic', 404006, 73544.9579)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 57429.09415)
    ops.uniaxialMaterial('Elastic', 404007, 73544.9579)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 30671.6187)
    ops.uniaxialMaterial('Elastic', 404008, 54221.57495)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 30671.6187)
    ops.uniaxialMaterial('Elastic', 404009, 54221.57495)
    ...
    # Central joint node
    ops.node(4010, 5.05, 8.8, 11.2, '-mass', 17.78460754332314, 17.78460754332314, 17.78460754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 4.85, 8.8, 11.2)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 5.25, 8.8, 11.2)
    ...
    ops.node(64010, 5.05, 8.6, 11.2)
    ops.element('elasticBeamColumn', 64010, 64010, 4010, 99999, 77777)
    ops.node(44010, 5.05, 9.0, 11.2)
    ops.element('elasticBeamColumn', 44010, 4010, 44010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 54099.7745)
    ops.uniaxialMaterial('Elastic', 404010, 69395.00315)
    ...
    # Central joint node
    ops.node(4011, 7.95, 8.8, 11.2, '-mass', 17.78460754332314, 17.78460754332314, 17.78460754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 7.75, 8.8, 11.2)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 8.15, 8.8, 11.2)
    ...
    ops.node(64011, 7.95, 8.6, 11.2)
    ops.element('elasticBeamColumn', 64011, 64011, 4011, 99999, 77777)
    ops.node(44011, 7.95, 9.0, 11.2)
    ops.element('elasticBeamColumn', 44011, 4011, 44011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 54099.7745)
    ops.uniaxialMaterial('Elastic', 404011, 69395.00315)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 30671.6187)
    ops.uniaxialMaterial('Elastic', 404012, 54221.57495)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 16253.66735)
    ops.uniaxialMaterial('Elastic', 404013, 22578.2268)
    ...
    # Central joint node
    ops.node(4014, 5.05, 13.2, 11.2, '-mass', 9.280988786952086, 9.280988786952086, 9.280988786952086, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 4.875, 13.2, 11.2)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 5.225, 13.2, 11.2)
    ...
    ops.node(64014, 5.05, 13.025, 11.2)
    ops.element('elasticBeamColumn', 64014, 64014, 4014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 38014.11895)
    ops.uniaxialMaterial('Elastic', 404014, 38014.11895)
    ...
    # Central joint node
    ops.node(4015, 7.95, 13.2, 11.2, '-mass', 9.280988786952086, 9.280988786952086, 9.280988786952086, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 7.775, 13.2, 11.2)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 8.125, 13.2, 11.2)
    ...
    ops.node(64015, 7.95, 13.025, 11.2)
    ops.element('elasticBeamColumn', 64015, 64015, 4015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 38014.11895)
    ops.uniaxialMaterial('Elastic', 404015, 38014.11895)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 16253.66735)
    ops.uniaxialMaterial('Elastic', 404016, 22578.2268)
