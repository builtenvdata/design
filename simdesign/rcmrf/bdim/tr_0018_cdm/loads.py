"""
Pydantic models for defining loads in tr_0018_cdm buildings.
"""
...
class Variable(VariableBase):
    """
    Model representing live loads (Q) for design class tr_0018_cdm.
...
class Combination(CombinationBase):
    """
    Model representing a load combination for design class tr_0018_cdm.
...
class LoadsData(LoadsDataBase):
    """
    Model representing the format of loads data for design class tr_0018_cdm.
