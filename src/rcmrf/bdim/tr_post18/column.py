...
class Column(ColumnBase):
    ...
    concrete: Concrete
    """Concrete material."""
    MIN_B_SQUARE: float = 0.30 * m
    """The default minimum square column dimension."""
    MIN_B_RECTANGLE: float = 0.30 * m
    ...
    def verify_section_adequacy(self) -> None:
        ...
        Vrdx = 0.85 * np.sqrt(self.fck / MPa) * (self.by / mm)*(dx / mm)/1000
        Vrdy = 0.85 * np.sqrt(self.fck / MPa) * (self.bx / mm)*(dy / mm)/1000
