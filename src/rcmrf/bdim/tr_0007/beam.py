"""
Specific routines for defining and designing tr_0007 beams.
...
class Beam(BeamBase):
    """Beam object for design class: tr_0007."""
    ...
    def compute_required_transverse_reinforcement(self) -> None:
        ...
        # Transverse reinforcement computation, Section 7.4.5 in TBEC-1998
