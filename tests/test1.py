...
import pytest
import pandas as pd
from src.rcmrf.bcim.parametrization import InputData
from src.rcmrf.bcim.parametrization import ArchetypeData
...
def all_json_data() -> dict:
    ...
    data_path = data_path / 'src' / 'rcmrf' / 'bcim' / 'standard' / 'data'
