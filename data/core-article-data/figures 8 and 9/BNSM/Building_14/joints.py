...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4018, 3.0, 0.0, 1.525, '-mass', 3.869877675840979, 3.869877675840979, 3.869877675840979, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 2.825, 0.0, 1.525)
    ...
    # Central joint node
    ops.node(4020, 3.0, 0.0, 4.425, '-mass', 3.8249235474006116, 3.8249235474006116, 3.8249235474006116, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54020, 2.825, 0.0, 4.425)
    ...
    ops.uniaxialMaterial('Elastic', 301001, 38390.90335)
    ops.uniaxialMaterial('Elastic', 401001, 32463.9614)
    ...
    # Central joint node
    ops.node(1002, 3.0, 0.0, 3.05, '-mass', 11.65499362895005, 11.65499362895005, 11.65499362895005, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51002, 2.825, 0.0, 3.05)
    ops.element('elasticBeamColumn', 51002, 51002, 1002, 99999, 88888)
    ops.node(31002, 3.175, 0.0, 3.05)
    ...
    ops.node(41002, 3.0, 0.175, 3.05)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 96077.9616)
    ops.uniaxialMaterial('Elastic', 401002, 98851.51055)
    ...
    # Central joint node
    ops.node(1003, 7.65, 0.0, 3.05, '-mass', 18.64230122324159, 18.64230122324159, 18.64230122324159, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51003, 7.45, 0.0, 3.05)
    ops.element('elasticBeamColumn', 51003, 51003, 1003, 99999, 88888)
    ops.node(31003, 7.85, 0.0, 3.05)
    ...
    ops.node(41003, 7.65, 0.2, 3.05)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 101482.0273)
    ops.uniaxialMaterial('Elastic', 401003, 110189.94965)
    ...
    # Central joint node
    ops.node(1004, 12.3, 0.0, 3.05, '-mass', 11.485880479102955, 11.485880479102955, 11.485880479102955, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 12.15, 0.0, 3.05)
    ...
    ops.node(41004, 12.3, 0.15, 3.05)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 51112.0276)
    ops.uniaxialMaterial('Elastic', 401004, 44321.95805)
    ...
    # Central joint node
    ops.node(1005, 0.0, 5.2, 3.05, '-mass', 12.060040774719676, 12.060040774719676, 12.060040774719676, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.15, 5.2, 3.05)
    ...
    ops.node(61005, 0.0, 5.05, 3.05)
    ops.element('elasticBeamColumn', 61005, 61005, 1005, 99999, 77777)
    ops.node(41005, 0.0, 5.35, 3.05)
    ops.element('elasticBeamColumn', 41005, 1005, 41005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 77602.6741)
    ops.uniaxialMaterial('Elastic', 401005, 48274.2713)
    ...
    # Central joint node
    ops.node(1006, 3.0, 5.2, 3.05, '-mass', 23.640364424057083, 23.640364424057083, 23.640364424057083, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 159726.15595)
    ops.uniaxialMaterial('Elastic', 401006, 123514.53775)
    ...
    # Central joint node
    ops.node(1007, 7.65, 5.2, 3.05, '-mass', 28.904785932721712, 28.904785932721712, 28.904785932721712, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 190650.5006)
    ops.uniaxialMaterial('Elastic', 401007, 151772.42045)
    ...
    # Central joint node
    ops.node(1008, 12.3, 5.2, 3.05, '-mass', 19.05677624872579, 19.05677624872579, 19.05677624872579, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 12.1, 5.2, 3.05)
    ...
    ops.node(61008, 12.3, 5.0, 3.05)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 12.3, 5.4, 3.05)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 126727.27425)
    ops.uniaxialMaterial('Elastic', 401008, 77937.4067)
    ...
    # Central joint node
    ops.node(1009, 0.0, 10.4, 3.05, '-mass', 12.878083588175329, 12.878083588175329, 12.878083588175329, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 77834.93285)
    ops.uniaxialMaterial('Elastic', 401009, 48411.61905)
    ...
    # Central joint node
    ops.node(1010, 3.0, 10.4, 3.05, '-mass', 22.603157492354743, 22.603157492354743, 22.603157492354743, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 157024.22395)
    ops.uniaxialMaterial('Elastic', 401010, 121425.1625)
    ...
    # Central joint node
    ops.node(1011, 7.65, 10.4, 3.05, '-mass', 28.90478593272171, 28.90478593272171, 28.90478593272171, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 190595.6149)
    ops.uniaxialMaterial('Elastic', 401011, 151728.7677)
    ...
    # Central joint node
    ops.node(1012, 12.3, 10.4, 3.05, '-mass', 19.056776248725786, 19.056776248725786, 19.056776248725786, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 12.1, 10.4, 3.05)
    ...
    ops.node(61012, 12.3, 10.2, 3.05)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 12.3, 10.6, 3.05)
    ops.element('elasticBeamColumn', 41012, 1012, 41012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 126695.3243)
    ops.uniaxialMaterial('Elastic', 401012, 77918.4863)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 35628.0528)
    ops.uniaxialMaterial('Elastic', 401013, 30843.0053)
    ...
    # Central joint node
    ops.node(1014, 3.0, 15.6, 3.05, '-mass', 14.89393348623853, 14.89393348623853, 14.89393348623853, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 2.825, 15.6, 3.05)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 3.175, 15.6, 3.05)
    ...
    ops.node(61014, 3.0, 15.425, 3.05)
    ops.element('elasticBeamColumn', 61014, 61014, 1014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 80370.8072)
    ops.uniaxialMaterial('Elastic', 401014, 86662.39405)
    ...
    # Central joint node
    ops.node(1015, 7.65, 15.6, 3.05, '-mass', 18.8698241590214, 18.8698241590214, 18.8698241590214, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 7.45, 15.6, 3.05)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 7.85, 15.6, 3.05)
    ...
    ops.node(61015, 7.65, 15.4, 3.05)
    ops.element('elasticBeamColumn', 61015, 61015, 1015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 101580.2874)
    ops.uniaxialMaterial('Elastic', 401015, 110302.1656)
    ...
    # Central joint node
    ops.node(1016, 12.3, 15.6, 3.05, '-mass', 11.599641946992861, 11.599641946992861, 11.599641946992861, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 12.15, 15.6, 3.05)
    ...
    ops.node(61016, 12.3, 15.45, 3.05)
    ops.element('elasticBeamColumn', 61016, 61016, 1016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 51155.458)
    ops.uniaxialMaterial('Elastic', 401016, 44359.9386)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 32794.38345)
    ops.uniaxialMaterial('Elastic', 402001, 27675.52455)
    ...
    # Central joint node
    ops.node(2002, 3.0, 0.0, 5.8, '-mass', 11.531599133537206, 11.531599133537206, 11.531599133537206, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52002, 2.825, 0.0, 5.8)
    ops.element('elasticBeamColumn', 52002, 52002, 2002, 99999, 88888)
    ops.node(32002, 3.175, 0.0, 5.8)
    ...
    ops.node(42002, 3.0, 0.175, 5.8)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 82314.4269)
    ops.uniaxialMaterial('Elastic', 402002, 83842.1099)
    ...
    # Central joint node
    ops.node(2003, 7.65, 0.0, 5.8, '-mass', 18.45743883792049, 18.45743883792049, 18.45743883792049, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52003, 7.45, 0.0, 5.8)
    ops.element('elasticBeamColumn', 52003, 52003, 2003, 99999, 88888)
    ops.node(32003, 7.85, 0.0, 5.8)
    ...
    ops.node(42003, 7.65, 0.2, 5.8)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 87480.4829)
    ops.uniaxialMaterial('Elastic', 402003, 94209.7325)
    ...
    # Central joint node
    ops.node(2004, 12.3, 0.0, 5.8, '-mass', 11.360345310907235, 11.360345310907235, 11.360345310907235, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 12.15, 0.0, 5.8)
    ...
    ops.node(42004, 12.3, 0.15, 5.8)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 44028.6219)
    ops.uniaxialMaterial('Elastic', 402004, 38126.8302)
    ...
    # Central joint node
    ops.node(2005, 0.0, 5.2, 5.8, '-mass', 11.934505606523956, 11.934505606523956, 11.934505606523956, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.15, 5.2, 5.8)
    ...
    ops.node(62005, 0.0, 5.05, 5.8)
    ops.element('elasticBeamColumn', 62005, 62005, 2005, 99999, 77777)
    ops.node(42005, 0.0, 5.35, 5.8)
    ops.element('elasticBeamColumn', 42005, 2005, 42005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 66678.97605)
    ops.uniaxialMaterial('Elastic', 402005, 41811.40975)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 137490.8696)
    ops.uniaxialMaterial('Elastic', 402006, 106320.2273)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 163619.65825)
    ops.uniaxialMaterial('Elastic', 402007, 130275.3575)
    ...
    # Central joint node
    ops.node(2008, 12.3, 5.2, 5.8, '-mass', 18.87191386340469, 18.87191386340469, 18.87191386340469, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 12.1, 5.2, 5.8)
    ...
    ops.node(62008, 12.3, 5.0, 5.8)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 12.3, 5.4, 5.8)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 108283.2642)
    ops.uniaxialMaterial('Elastic', 402008, 67007.17835)
    ...
    # Central joint node
    ops.node(2009, 0.0, 10.4, 5.8, '-mass', 12.715851172273188, 12.715851172273188, 12.715851172273188, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 66150.0944)
    ops.uniaxialMaterial('Elastic', 402009, 35412.4548)
    ...
    # Central joint node
    ops.node(2010, 3.0, 10.4, 5.8, '-mass', 22.324717125382264, 22.324717125382264, 22.324717125382264, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 134643.97155)
    ops.uniaxialMaterial('Elastic', 402010, 89607.97865)
    ...
    # Central joint node
    ops.node(2011, 7.65, 10.4, 5.8, '-mass', 28.4475993883792, 28.4475993883792, 28.4475993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 163555.7019)
    ops.uniaxialMaterial('Elastic', 402011, 112075.43285)
    ...
    # Central joint node
    ops.node(2012, 12.3, 10.4, 5.8, '-mass', 18.81503312945973, 18.81503312945973, 18.81503312945973, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 12.1, 10.4, 5.8)
    ...
    ops.node(62012, 12.3, 10.2, 5.8)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 12.3, 10.6, 5.8)
    ops.element('elasticBeamColumn', 42012, 2012, 42012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 108245.87045)
    ops.uniaxialMaterial('Elastic', 402012, 57250.77015)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 30661.0286)
    ops.uniaxialMaterial('Elastic', 402013, 26497.5648)
    ...
    # Central joint node
    ops.node(2014, 3.0, 15.6, 5.8, '-mass', 14.45998853211009, 14.45998853211009, 14.45998853211009, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 2.825, 15.6, 5.8)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 3.175, 15.6, 5.8)
    ...
    ops.node(62014, 3.0, 15.425, 5.8)
    ops.element('elasticBeamColumn', 62014, 62014, 2014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 69173.2718)
    ops.uniaxialMaterial('Elastic', 402014, 73872.05025)
    ...
    # Central joint node
    ops.node(2015, 7.65, 15.6, 5.8, '-mass', 18.457438837920485, 18.457438837920485, 18.457438837920485, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 7.45, 15.6, 5.8)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 7.85, 15.6, 5.8)
    ...
    ops.node(62015, 7.65, 15.4, 5.8)
    ops.element('elasticBeamColumn', 62015, 62015, 2015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 87480.4829)
    ops.uniaxialMaterial('Elastic', 402015, 94209.7325)
    ...
    # Central joint node
    ops.node(2016, 12.3, 15.6, 5.8, '-mass', 11.360345310907233, 11.360345310907233, 11.360345310907233, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 12.15, 15.6, 5.8)
    ...
    ops.node(62016, 12.3, 15.45, 5.8)
    ops.element('elasticBeamColumn', 62016, 62016, 2016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 44028.6219)
    ops.uniaxialMaterial('Elastic', 402016, 38126.8302)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 25031.21065)
    ops.uniaxialMaterial('Elastic', 403001, 21028.60695)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 46058.1632)
    ops.uniaxialMaterial('Elastic', 403002, 45745.1968)
    ...
    # Central joint node
    ops.node(3003, 7.65, 0.0, 8.55, '-mass', 18.33129204892966, 18.33129204892966, 18.33129204892966, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53003, 7.475, 0.0, 8.55)
    ops.element('elasticBeamColumn', 53003, 53003, 3003, 99999, 88888)
    ops.node(33003, 7.825, 0.0, 8.55)
    ...
    ops.node(43003, 7.65, 0.175, 8.55)
    ops.element('elasticBeamColumn', 43003, 3003, 43003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 61626.1242)
    ops.uniaxialMaterial('Elastic', 403003, 65261.11425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 29454.3945)
    ops.uniaxialMaterial('Elastic', 403004, 25441.7049)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 44438.9824)
    ops.uniaxialMaterial('Elastic', 403005, 24122.97685)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 96716.42155)
    ops.uniaxialMaterial('Elastic', 403006, 64366.51365)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 104393.5306)
    ops.uniaxialMaterial('Elastic', 403007, 69475.7675)
    ...
    # Central joint node
    ops.node(3008, 12.3, 5.2, 8.55, '-mass', 18.68888634046891, 18.68888634046891, 18.68888634046891, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 12.125, 5.2, 8.55)
    ...
    ops.node(63008, 12.3, 5.025, 8.55)
    ops.element('elasticBeamColumn', 63008, 63008, 3008, 99999, 77777)
    ops.node(43008, 12.3, 5.375, 8.55)
    ops.element('elasticBeamColumn', 43008, 3008, 43008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 74913.92335)
    ops.uniaxialMaterial('Elastic', 403008, 40071.15895)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 43060.68275)
    ops.uniaxialMaterial('Elastic', 403009, 23420.64895)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 93989.47415)
    ops.uniaxialMaterial('Elastic', 403010, 62551.68125)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 104393.5306)
    ops.uniaxialMaterial('Elastic', 403011, 69475.7675)
    ...
    # Central joint node
    ops.node(3012, 12.3, 10.4, 8.55, '-mass', 18.688886340468905, 18.688886340468905, 18.688886340468905, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 12.125, 10.4, 8.55)
    ...
    ops.node(63012, 12.3, 10.225, 8.55)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    ops.node(43012, 12.3, 10.575, 8.55)
    ops.element('elasticBeamColumn', 43012, 3012, 43012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 74913.92335)
    ops.uniaxialMaterial('Elastic', 403012, 40071.15895)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 24651.15265)
    ops.uniaxialMaterial('Elastic', 403013, 21237.3279)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 39628.056)
    ops.uniaxialMaterial('Elastic', 403014, 41381.3913)
    ...
    # Central joint node
    ops.node(3015, 7.65, 15.6, 8.55, '-mass', 18.331292048929658, 18.331292048929658, 18.331292048929658, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53015, 7.475, 15.6, 8.55)
    ops.element('elasticBeamColumn', 53015, 53015, 3015, 99999, 88888)
    ops.node(33015, 7.825, 15.6, 8.55)
    ...
    ops.node(63015, 7.65, 15.425, 8.55)
    ops.element('elasticBeamColumn', 63015, 63015, 3015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 61626.1242)
    ops.uniaxialMaterial('Elastic', 403015, 65261.11425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 29454.3945)
    ops.uniaxialMaterial('Elastic', 403016, 25441.7049)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 11324.88605)
    ops.uniaxialMaterial('Elastic', 404001, 9221.3939)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 30796.86225)
    ops.uniaxialMaterial('Elastic', 404002, 19264.86655)
    ...
    # Central joint node
    ops.node(4003, 7.65, 0.0, 11.3, '-mass', 13.066345565749234, 13.066345565749234, 13.066345565749234, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54003, 7.475, 0.0, 11.3)
    ops.element('elasticBeamColumn', 54003, 54003, 4003, 99999, 88888)
    ops.node(34003, 7.825, 0.0, 11.3)
    ...
    ops.node(44003, 7.65, 0.175, 11.3)
    ops.element('elasticBeamColumn', 44003, 4003, 44003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 63471.2518)
    ops.uniaxialMaterial('Elastic', 404003, 35790.17265)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 26363.43535)
    ops.uniaxialMaterial('Elastic', 404004, 18933.71705)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 27300.83195)
    ops.uniaxialMaterial('Elastic', 404005, 27300.83195)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 66966.38985)
    ops.uniaxialMaterial('Elastic', 404006, 50774.01295)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 78433.43545)
    ops.uniaxialMaterial('Elastic', 404007, 52934.2697)
    ...
    # Central joint node
    ops.node(4008, 12.3, 5.2, 11.3, '-mass', 13.004571865443426, 13.004571865443426, 13.004571865443426, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 12.125, 5.2, 11.3)
    ...
    ops.node(64008, 12.3, 5.025, 11.3)
    ops.element('elasticBeamColumn', 64008, 64008, 4008, 99999, 77777)
    ops.node(44008, 12.3, 5.375, 11.3)
    ops.element('elasticBeamColumn', 44008, 4008, 44008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 49131.7175)
    ops.uniaxialMaterial('Elastic', 404008, 42325.95075)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 23497.50765)
    ops.uniaxialMaterial('Elastic', 404009, 23497.50765)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 62838.58)
    ops.uniaxialMaterial('Elastic', 404010, 47554.52005)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 78433.43545)
    ops.uniaxialMaterial('Elastic', 404011, 52934.2697)
    ...
    # Central joint node
    ops.node(4012, 12.3, 10.4, 11.3, '-mass', 13.004571865443424, 13.004571865443424, 13.004571865443424, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 12.125, 10.4, 11.3)
    ...
    ops.node(64012, 12.3, 10.225, 11.3)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 12.3, 10.575, 11.3)
    ops.element('elasticBeamColumn', 44012, 4012, 44012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 49131.7175)
    ops.uniaxialMaterial('Elastic', 404012, 42325.95075)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 18348.94195)
    ops.uniaxialMaterial('Elastic', 404013, 15297.90425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 35661.81575)
    ops.uniaxialMaterial('Elastic', 404014, 22535.89135)
    ...
    # Central joint node
    ops.node(4015, 7.65, 15.6, 11.3, '-mass', 13.066345565749234, 13.066345565749234, 13.066345565749234, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 7.475, 15.6, 11.3)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 7.825, 15.6, 11.3)
    ...
    ops.node(64015, 7.65, 15.425, 11.3)
    ops.element('elasticBeamColumn', 64015, 64015, 4015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 63471.2518)
    ops.uniaxialMaterial('Elastic', 404015, 35790.17265)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 26363.43535)
    ops.uniaxialMaterial('Elastic', 404016, 18933.71705)
