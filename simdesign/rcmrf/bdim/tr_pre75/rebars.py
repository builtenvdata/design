"""
The model used for detailing the structural members of tr_pre75 buildings.
"""
...
class Rebars(RebarsBase):
    ...
    def get_min_beam_dbh(self, **kwargs) -> float | np.ndarray:
    ...
    def get_min_col_dbh(self, **kwargs) -> float | np.ndarray:
    ...
    def get_col_max_sbh(self, **kwargs) -> float | np.ndarray:
    ...
    def get_beam_max_sbh(self, **kwargs) -> float | np.ndarray:
        """Gets maximum spacing between horizontal bars
