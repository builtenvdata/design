...
def do_nspa_x(max_drift: float = 0.1, dincr: float = 0.001) -> tuple[list[float], list[float]]:
    ...
    ops.load(91000, 0.1190861036680788, 0, 0, 0, 0, 0)
    ops.load(92000, 0.22139806964018835, 0, 0, 0, 0, 0)
    ops.load(93000, 0.36086456580364323, 0, 0, 0, 0, 0)
    ops.load(94000, 0.29865126088808963, 0, 0, 0, 0, 0)
...
def do_nspa_y(max_drift: float = 0.1, dincr: float = 0.001) -> tuple[list[float], list[float]]:
    ...
    ops.pattern('Plain', 2, 2)
    # Add lateral nspa loads to ops domain
    ops.load(91000, 0, 0.12393620393578222, 0, 0, 0, 0)
    ops.load(92000, 0, 0.22681928210912433, 0, 0, 0, 0)
    ops.load(93000, 0, 0.35948235180493016, 0, 0, 0, 0)
    ops.load(94000, 0, 0.2897621621501633, 0, 0, 0, 0)
