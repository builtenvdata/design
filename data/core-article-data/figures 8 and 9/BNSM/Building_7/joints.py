...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4017, 5.45, 0.0, 1.15, '-mass', 3.40301987767584, 3.40301987767584, 3.40301987767584, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4018, 8.35, 0.0, 1.15, '-mass', 3.40301987767584, 3.40301987767584, 3.40301987767584, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4019, 5.45, 0.0, 3.45, '-mass', 3.40301987767584, 3.40301987767584, 3.40301987767584, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4020, 8.35, 0.0, 3.45, '-mass', 3.40301987767584, 3.40301987767584, 3.40301987767584, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4021, 5.45, 0.0, 5.75, '-mass', 3.2904816513761457, 3.2904816513761457, 3.2904816513761457, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4022, 8.35, 0.0, 5.75, '-mass', 3.2904816513761457, 3.2904816513761457, 3.2904816513761457, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4023, 5.45, 0.0, 8.05, '-mass', 3.2904816513761457, 3.2904816513761457, 3.2904816513761457, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4024, 8.35, 0.0, 8.05, '-mass', 3.2904816513761457, 3.2904816513761457, 3.2904816513761457, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 2.3, '-mass', 9.178099109772287, 9.178099109772287, 9.178099109772287, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41001, 0.0, 0.2, 2.3)
    ops.element('elasticBeamColumn', 41001, 1001, 41001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301001, 34612.08155)
    ops.uniaxialMaterial('Elastic', 401001, 57707.61455)
    ...
    # Central joint node
    ops.node(1002, 5.45, 0.0, 2.3, '-mass', 9.772594522616322, 9.772594522616322, 9.772594522616322, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41002, 5.45, 0.275, 2.3)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 68653.65505)
    ops.uniaxialMaterial('Elastic', 401002, 145861.715)
    ...
    # Central joint node
    ops.node(1003, 8.35, 0.0, 2.3, '-mass', 9.772594522616323, 9.772594522616323, 9.772594522616323, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41003, 8.35, 0.275, 2.3)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 68653.65505)
    ops.uniaxialMaterial('Elastic', 401003, 145861.715)
    ...
    # Central joint node
    ops.node(1004, 13.8, 0.0, 2.3, '-mass', 9.178099109772287, 9.178099109772287, 9.178099109772287, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41004, 13.8, 0.2, 2.3)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 34612.08155)
    ops.uniaxialMaterial('Elastic', 401004, 57707.61455)
    ...
    # Central joint node
    ops.node(1005, 0.0, 4.45, 2.3, '-mass', 13.640245110472197, 13.640245110472197, 13.640245110472197, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.3, 4.45, 2.3)
    ...
    ops.node(61005, 0.0, 4.275, 2.3)
    ops.element('elasticBeamColumn', 61005, 61005, 1005, 99999, 77777)
    ops.node(41005, 0.0, 4.625, 2.3)
    ops.element('elasticBeamColumn', 41005, 1005, 41005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 78154.59285)
    ops.uniaxialMaterial('Elastic', 401005, 126110.04175)
    ...
    # Central joint node
    ops.node(1006, 5.45, 4.45, 2.3, '-mass', 16.871467833783143, 16.871467833783143, 16.871467833783143, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51006, 5.125, 4.45, 2.3)
    ops.element('elasticBeamColumn', 51006, 51006, 1006, 99999, 88888)
    ops.node(31006, 5.775, 4.45, 2.3)
    ...
    ops.node(61006, 5.45, 4.275, 2.3)
    ops.element('elasticBeamColumn', 61006, 61006, 1006, 99999, 77777)
    ops.node(41006, 5.45, 4.625, 2.3)
    ops.element('elasticBeamColumn', 41006, 1006, 41006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 101746.4566)
    ops.uniaxialMaterial('Elastic', 401006, 205500.0423)
    ...
    # Central joint node
    ops.node(1007, 8.35, 4.45, 2.3, '-mass', 16.871467833783147, 16.871467833783147, 16.871467833783147, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51007, 8.025, 4.45, 2.3)
    ops.element('elasticBeamColumn', 51007, 51007, 1007, 99999, 88888)
    ops.node(31007, 8.675, 4.45, 2.3)
    ...
    ops.node(61007, 8.35, 4.275, 2.3)
    ops.element('elasticBeamColumn', 61007, 61007, 1007, 99999, 77777)
    ops.node(41007, 8.35, 4.625, 2.3)
    ops.element('elasticBeamColumn', 41007, 1007, 41007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 101746.4566)
    ops.uniaxialMaterial('Elastic', 401007, 205500.0423)
    ...
    # Central joint node
    ops.node(1008, 13.8, 4.45, 2.3, '-mass', 13.6402451104722, 13.6402451104722, 13.6402451104722, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 13.5, 4.45, 2.3)
    ...
    ops.node(61008, 13.8, 4.275, 2.3)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 13.8, 4.625, 2.3)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 78154.59285)
    ops.uniaxialMaterial('Elastic', 401008, 126110.04175)
    ...
    # Central joint node
    ops.node(1009, 0.0, 8.9, 2.3, '-mass', 13.640245110472195, 13.640245110472195, 13.640245110472195, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31009, 0.3, 8.9, 2.3)
    ...
    ops.node(61009, 0.0, 8.725, 2.3)
    ops.element('elasticBeamColumn', 61009, 61009, 1009, 99999, 77777)
    ops.node(41009, 0.0, 9.075, 2.3)
    ops.element('elasticBeamColumn', 41009, 1009, 41009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 78154.59285)
    ops.uniaxialMaterial('Elastic', 401009, 126110.04175)
    ...
    # Central joint node
    ops.node(1010, 5.45, 8.9, 2.3, '-mass', 14.461278732425393, 14.461278732425393, 14.461278732425393, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 5.175, 8.9, 2.3)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 5.725, 8.9, 2.3)
    ...
    ops.node(61010, 5.45, 8.75, 2.3)
    ops.element('elasticBeamColumn', 61010, 61010, 1010, 99999, 77777)
    ops.node(41010, 5.45, 9.05, 2.3)
    ops.element('elasticBeamColumn', 41010, 1010, 41010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 85540.15005)
    ops.uniaxialMaterial('Elastic', 401010, 162597.65775)
    ...
    # Central joint node
    ops.node(1011, 8.35, 8.9, 2.3, '-mass', 14.461278732425395, 14.461278732425395, 14.461278732425395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 8.075, 8.9, 2.3)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 8.625, 8.9, 2.3)
    ...
    ops.node(61011, 8.35, 8.75, 2.3)
    ops.element('elasticBeamColumn', 61011, 61011, 1011, 99999, 77777)
    ops.node(41011, 8.35, 9.05, 2.3)
    ops.element('elasticBeamColumn', 41011, 1011, 41011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 85540.15005)
    ops.uniaxialMaterial('Elastic', 401011, 162597.65775)
    ...
    # Central joint node
    ops.node(1012, 13.8, 8.9, 2.3, '-mass', 13.640245110472199, 13.640245110472199, 13.640245110472199, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 13.5, 8.9, 2.3)
    ...
    ops.node(61012, 13.8, 8.725, 2.3)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 13.8, 9.075, 2.3)
    ops.element('elasticBeamColumn', 41012, 1012, 41012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 78154.59285)
    ops.uniaxialMaterial('Elastic', 401012, 126110.04175)
    ...
    # Central joint node
    ops.node(1013, 0.0, 13.35, 2.3, '-mass', 9.178099109772287, 9.178099109772287, 9.178099109772287, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61013, 0.0, 13.15, 2.3)
    ops.element('elasticBeamColumn', 61013, 61013, 1013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 34612.08155)
    ops.uniaxialMaterial('Elastic', 401013, 57707.61455)
    ...
    # Central joint node
    ops.node(1014, 5.45, 13.35, 2.3, '-mass', 11.181837123603112, 11.181837123603112, 11.181837123603112, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61014, 5.45, 13.125, 2.3)
    ops.element('elasticBeamColumn', 61014, 61014, 1014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 48976.7708)
    ops.uniaxialMaterial('Elastic', 401014, 100167.81205)
    ...
    # Central joint node
    ops.node(1015, 8.35, 13.35, 2.3, '-mass', 11.181837123603112, 11.181837123603112, 11.181837123603112, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61015, 8.35, 13.125, 2.3)
    ops.element('elasticBeamColumn', 61015, 61015, 1015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 48976.7708)
    ops.uniaxialMaterial('Elastic', 401015, 100167.81205)
    ...
    # Central joint node
    ops.node(1016, 13.8, 13.35, 2.3, '-mass', 9.178099109772287, 9.178099109772287, 9.178099109772287, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61016, 13.8, 13.15, 2.3)
    ops.element('elasticBeamColumn', 61016, 61016, 1016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 34612.08155)
    ops.uniaxialMaterial('Elastic', 401016, 57707.61455)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 4.6, '-mass', 9.142930914053633, 9.142930914053633, 9.142930914053633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42001, 0.0, 0.2, 4.6)
    ops.element('elasticBeamColumn', 42001, 2001, 42001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 29679.9301)
    ops.uniaxialMaterial('Elastic', 402001, 50001.3519)
    ...
    # Central joint node
    ops.node(2002, 5.45, 0.0, 4.6, '-mass', 9.716325409466476, 9.716325409466476, 9.716325409466476, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42002, 5.45, 0.275, 4.6)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 58485.94275)
    ops.uniaxialMaterial('Elastic', 402002, 123471.3464)
    ...
    # Central joint node
    ops.node(2003, 8.35, 0.0, 4.6, '-mass', 9.716325409466478, 9.716325409466478, 9.716325409466478, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42003, 8.35, 0.275, 4.6)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 58485.94275)
    ops.uniaxialMaterial('Elastic', 402003, 123471.3464)
    ...
    # Central joint node
    ops.node(2004, 13.8, 0.0, 4.6, '-mass', 9.142930914053633, 9.142930914053633, 9.142930914053633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42004, 13.8, 0.2, 4.6)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 29679.9301)
    ops.uniaxialMaterial('Elastic', 402004, 50001.3519)
    ...
    # Central joint node
    ops.node(2005, 0.0, 4.45, 4.6, '-mass', 13.401101379585347, 13.401101379585347, 13.401101379585347, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.3, 4.45, 4.6)
    ...
    ops.node(62005, 0.0, 4.275, 4.6)
    ops.element('elasticBeamColumn', 62005, 62005, 2005, 99999, 77777)
    ops.node(42005, 0.0, 4.625, 4.6)
    ops.element('elasticBeamColumn', 42005, 2005, 42005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 66773.74355)
    ops.uniaxialMaterial('Elastic', 402005, 108687.7359)
    ...
    # Central joint node
    ops.node(2006, 5.45, 4.45, 4.6, '-mass', 16.61825682460883, 16.61825682460883, 16.61825682460883, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52006, 5.125, 4.45, 4.6)
    ops.element('elasticBeamColumn', 52006, 52006, 2006, 99999, 88888)
    ops.node(32006, 5.775, 4.45, 4.6)
    ...
    ops.node(62006, 5.45, 4.275, 4.6)
    ops.element('elasticBeamColumn', 62006, 62006, 2006, 99999, 77777)
    ops.node(42006, 5.45, 4.625, 4.6)
    ops.element('elasticBeamColumn', 42006, 2006, 42006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 87703.9644)
    ops.uniaxialMaterial('Elastic', 402006, 177293.669)
    ...
    # Central joint node
    ops.node(2007, 8.35, 4.45, 4.6, '-mass', 16.618256824608835, 16.618256824608835, 16.618256824608835, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52007, 8.025, 4.45, 4.6)
    ops.element('elasticBeamColumn', 52007, 52007, 2007, 99999, 88888)
    ops.node(32007, 8.675, 4.45, 4.6)
    ...
    ops.node(62007, 8.35, 4.275, 4.6)
    ops.element('elasticBeamColumn', 62007, 62007, 2007, 99999, 77777)
    ops.node(42007, 8.35, 4.625, 4.6)
    ops.element('elasticBeamColumn', 42007, 2007, 42007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 87703.9644)
    ops.uniaxialMaterial('Elastic', 402007, 177293.669)
    ...
    # Central joint node
    ops.node(2008, 13.8, 4.45, 4.6, '-mass', 13.40110137958535, 13.40110137958535, 13.40110137958535, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 13.5, 4.45, 4.6)
    ...
    ops.node(62008, 13.8, 4.275, 4.6)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 13.8, 4.625, 4.6)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 66773.74355)
    ops.uniaxialMaterial('Elastic', 402008, 108687.7359)
    ...
    # Central joint node
    ops.node(2009, 0.0, 8.9, 4.6, '-mass', 13.401101379585345, 13.401101379585345, 13.401101379585345, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32009, 0.3, 8.9, 4.6)
    ...
    ops.node(62009, 0.0, 8.725, 4.6)
    ops.element('elasticBeamColumn', 62009, 62009, 2009, 99999, 77777)
    ops.node(42009, 0.0, 9.075, 4.6)
    ops.element('elasticBeamColumn', 42009, 2009, 42009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 66773.74355)
    ops.uniaxialMaterial('Elastic', 402009, 108687.7359)
    ...
    # Central joint node
    ops.node(2010, 5.45, 8.9, 4.6, '-mass', 14.348740506125699, 14.348740506125699, 14.348740506125699, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 5.175, 8.9, 4.6)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 5.725, 8.9, 4.6)
    ...
    ops.node(62010, 5.45, 8.75, 4.6)
    ops.element('elasticBeamColumn', 62010, 62010, 2010, 99999, 77777)
    ops.node(42010, 5.45, 9.05, 4.6)
    ops.element('elasticBeamColumn', 42010, 2010, 42010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 73458.2084)
    ops.uniaxialMaterial('Elastic', 402010, 139682.05495)
    ...
    # Central joint node
    ops.node(2011, 8.35, 8.9, 4.6, '-mass', 14.3487405061257, 14.3487405061257, 14.3487405061257, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 8.075, 8.9, 4.6)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 8.625, 8.9, 4.6)
    ...
    ops.node(62011, 8.35, 8.75, 4.6)
    ops.element('elasticBeamColumn', 62011, 62011, 2011, 99999, 77777)
    ops.node(42011, 8.35, 9.05, 4.6)
    ops.element('elasticBeamColumn', 42011, 2011, 42011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 73458.2084)
    ops.uniaxialMaterial('Elastic', 402011, 139682.05495)
    ...
    # Central joint node
    ops.node(2012, 13.8, 8.9, 4.6, '-mass', 13.401101379585349, 13.401101379585349, 13.401101379585349, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 13.5, 8.9, 4.6)
    ...
    ops.node(62012, 13.8, 8.725, 4.6)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 13.8, 9.075, 4.6)
    ops.element('elasticBeamColumn', 42012, 2012, 42012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 66773.74355)
    ops.uniaxialMaterial('Elastic', 402012, 108687.7359)
    ...
    # Central joint node
    ops.node(2013, 0.0, 13.35, 4.6, '-mass', 9.142930914053633, 9.142930914053633, 9.142930914053633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62013, 0.0, 13.15, 4.6)
    ops.element('elasticBeamColumn', 62013, 62013, 2013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 29679.9301)
    ops.uniaxialMaterial('Elastic', 402013, 50001.3519)
    ...
    # Central joint node
    ops.node(2014, 5.45, 13.35, 4.6, '-mass', 11.048197979872226, 11.048197979872226, 11.048197979872226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62014, 5.45, 13.125, 4.6)
    ops.element('elasticBeamColumn', 62014, 62014, 2014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 42019.06805)
    ops.uniaxialMaterial('Elastic', 402014, 85357.29595)
    ...
    # Central joint node
    ops.node(2015, 8.35, 13.35, 4.6, '-mass', 11.048197979872226, 11.048197979872226, 11.048197979872226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62015, 8.35, 13.125, 4.6)
    ops.element('elasticBeamColumn', 62015, 62015, 2015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 42019.06805)
    ops.uniaxialMaterial('Elastic', 402015, 85357.29595)
    ...
    # Central joint node
    ops.node(2016, 13.8, 13.35, 4.6, '-mass', 9.142930914053633, 9.142930914053633, 9.142930914053633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62016, 13.8, 13.15, 4.6)
    ops.element('elasticBeamColumn', 62016, 62016, 2016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 29679.9301)
    ops.uniaxialMaterial('Elastic', 402016, 50001.3519)
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 6.9, '-mass', 9.107762718334978, 9.107762718334978, 9.107762718334978, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43001, 0.0, 0.175, 6.9)
    ops.element('elasticBeamColumn', 43001, 3001, 43001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 22217.54135)
    ops.uniaxialMaterial('Elastic', 403001, 40625.94675)
    ...
    # Central joint node
    ops.node(3002, 5.45, 0.0, 6.9, '-mass', 9.66005629631663, 9.66005629631663, 9.66005629631663, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43002, 5.45, 0.25, 6.9)
    ops.element('elasticBeamColumn', 43002, 3002, 43002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 43357.0114)
    ops.uniaxialMaterial('Elastic', 403002, 82894.95045)
    ...
    # Central joint node
    ops.node(3003, 8.35, 0.0, 6.9, '-mass', 9.660056296316633, 9.660056296316633, 9.660056296316633, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43003, 8.35, 0.25, 6.9)
    ops.element('elasticBeamColumn', 43003, 3003, 43003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 43357.0114)
    ops.uniaxialMaterial('Elastic', 403003, 82894.95045)
    ...
    # Central joint node
    ops.node(3004, 13.8, 0.0, 6.9, '-mass', 9.107762718334978, 9.107762718334978, 9.107762718334978, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43004, 13.8, 0.175, 6.9)
    ops.element('elasticBeamColumn', 43004, 3004, 43004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 22217.54135)
    ops.uniaxialMaterial('Elastic', 403004, 40625.94675)
    ...
    # Central joint node
    ops.node(3005, 0.0, 4.45, 6.9, '-mass', 13.161957648698497, 13.161957648698497, 13.161957648698497, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33005, 0.25, 4.45, 6.9)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 42168.9368)
    ops.uniaxialMaterial('Elastic', 403005, 66688.9145)
    ...
    # Central joint node
    ops.node(3006, 5.45, 4.45, 6.9, '-mass', 16.36504581543452, 16.36504581543452, 16.36504581543452, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53006, 5.175, 4.45, 6.9)
    ops.element('elasticBeamColumn', 53006, 53006, 3006, 99999, 88888)
    ops.node(33006, 5.725, 4.45, 6.9)
    ...
    ops.node(63006, 5.45, 4.325, 6.9)
    ops.element('elasticBeamColumn', 63006, 63006, 3006, 99999, 77777)
    ops.node(43006, 5.45, 4.575, 6.9)
    ops.element('elasticBeamColumn', 43006, 3006, 43006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 56576.98305)
    ops.uniaxialMaterial('Elastic', 403006, 110477.75405)
    ...
    # Central joint node
    ops.node(3007, 8.35, 4.45, 6.9, '-mass', 16.365045815434524, 16.365045815434524, 16.365045815434524, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53007, 8.075, 4.45, 6.9)
    ops.element('elasticBeamColumn', 53007, 53007, 3007, 99999, 88888)
    ops.node(33007, 8.625, 4.45, 6.9)
    ...
    ops.node(63007, 8.35, 4.325, 6.9)
    ops.element('elasticBeamColumn', 63007, 63007, 3007, 99999, 77777)
    ops.node(43007, 8.35, 4.575, 6.9)
    ops.element('elasticBeamColumn', 43007, 3007, 43007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 56576.98305)
    ops.uniaxialMaterial('Elastic', 403007, 110477.75405)
    ...
    # Central joint node
    ops.node(3008, 13.8, 4.45, 6.9, '-mass', 13.1619576486985, 13.1619576486985, 13.1619576486985, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 13.55, 4.45, 6.9)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 42168.9368)
    ops.uniaxialMaterial('Elastic', 403008, 66688.9145)
    ...
    # Central joint node
    ops.node(3009, 0.0, 8.9, 6.9, '-mass', 13.161957648698495, 13.161957648698495, 13.161957648698495, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33009, 0.25, 8.9, 6.9)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 42168.9368)
    ops.uniaxialMaterial('Elastic', 403009, 66688.9145)
    ...
    # Central joint node
    ops.node(3010, 5.45, 8.9, 6.9, '-mass', 14.236202279826005, 14.236202279826005, 14.236202279826005, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53010, 5.2, 8.9, 6.9)
    ops.element('elasticBeamColumn', 53010, 53010, 3010, 99999, 88888)
    ops.node(33010, 5.7, 8.9, 6.9)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 52217.88795)
    ops.uniaxialMaterial('Elastic', 403010, 97085.66155)
    ...
    # Central joint node
    ops.node(3011, 8.35, 8.9, 6.9, '-mass', 14.236202279826006, 14.236202279826006, 14.236202279826006, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53011, 8.1, 8.9, 6.9)
    ops.element('elasticBeamColumn', 53011, 53011, 3011, 99999, 88888)
    ops.node(33011, 8.6, 8.9, 6.9)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 52217.88795)
    ops.uniaxialMaterial('Elastic', 403011, 97085.66155)
    ...
    # Central joint node
    ops.node(3012, 13.8, 8.9, 6.9, '-mass', 13.161957648698499, 13.161957648698499, 13.161957648698499, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 13.55, 8.9, 6.9)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 42168.9368)
    ops.uniaxialMaterial('Elastic', 403012, 66688.9145)
    ...
    # Central joint node
    ops.node(3013, 0.0, 13.35, 6.9, '-mass', 9.107762718334978, 9.107762718334978, 9.107762718334978, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63013, 0.0, 13.175, 6.9)
    ops.element('elasticBeamColumn', 63013, 63013, 3013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 22217.54135)
    ops.uniaxialMaterial('Elastic', 403013, 40625.94675)
    ...
    # Central joint node
    ops.node(3014, 5.45, 13.35, 6.9, '-mass', 10.91455883614134, 10.91455883614134, 10.91455883614134, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63014, 5.45, 13.175, 6.9)
    ops.element('elasticBeamColumn', 63014, 63014, 3014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 29794.43705)
    ops.uniaxialMaterial('Elastic', 403014, 58972.60335)
    ...
    # Central joint node
    ops.node(3015, 8.35, 13.35, 6.9, '-mass', 10.91455883614134, 10.91455883614134, 10.91455883614134, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63015, 8.35, 13.175, 6.9)
    ops.element('elasticBeamColumn', 63015, 63015, 3015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 29794.43705)
    ops.uniaxialMaterial('Elastic', 403015, 58972.60335)
    ...
    # Central joint node
    ops.node(3016, 13.8, 13.35, 6.9, '-mass', 9.107762718334978, 9.107762718334978, 9.107762718334978, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63016, 13.8, 13.175, 6.9)
    ops.element('elasticBeamColumn', 63016, 63016, 3016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 22217.54135)
    ops.uniaxialMaterial('Elastic', 403016, 40625.94675)
    ...
    # Central joint node
    ops.node(4001, 0.0, 0.0, 9.2, '-mass', 4.454207672463417, 4.454207672463417, 4.454207672463417, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44001, 0.0, 0.175, 9.2)
    ops.element('elasticBeamColumn', 44001, 4001, 44001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 16720.2507)
    ops.uniaxialMaterial('Elastic', 404001, 27220.614)
    ...
    # Central joint node
    ops.node(4002, 5.45, 0.0, 9.2, '-mass', 4.837388100597973, 4.837388100597973, 4.837388100597973, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44002, 5.45, 0.25, 9.2)
    ops.element('elasticBeamColumn', 44002, 4002, 44002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 24318.3002)
    ops.uniaxialMaterial('Elastic', 404002, 27970.56855)
    ...
    # Central joint node
    ops.node(4003, 8.35, 0.0, 9.2, '-mass', 4.837388100597974, 4.837388100597974, 4.837388100597974, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44003, 8.35, 0.25, 9.2)
    ops.element('elasticBeamColumn', 44003, 4003, 44003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 24318.3002)
    ops.uniaxialMaterial('Elastic', 404003, 27970.56855)
    ...
    # Central joint node
    ops.node(4004, 13.8, 0.0, 9.2, '-mass', 4.454207672463418, 4.454207672463418, 4.454207672463418, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44004, 13.8, 0.175, 9.2)
    ops.element('elasticBeamColumn', 44004, 4004, 44004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 16720.2507)
    ops.uniaxialMaterial('Elastic', 404004, 27220.614)
    ...
    # Central joint node
    ops.node(4005, 0.0, 4.45, 9.2, '-mass', 8.467742562052218, 8.467742562052218, 8.467742562052218, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34005, 0.25, 4.45, 9.2)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 25399.9652)
    ops.uniaxialMaterial('Elastic', 404005, 55953.72015)
    ...
    # Central joint node
    ops.node(4006, 5.45, 4.45, 9.2, '-mass', 12.857502492294868, 12.857502492294868, 12.857502492294868, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54006, 5.175, 4.45, 9.2)
    ops.element('elasticBeamColumn', 54006, 54006, 4006, 99999, 88888)
    ops.node(34006, 5.725, 4.45, 9.2)
    ...
    ops.node(64006, 5.45, 4.325, 9.2)
    ops.element('elasticBeamColumn', 64006, 64006, 4006, 99999, 77777)
    ops.node(44006, 5.45, 4.575, 9.2)
    ops.element('elasticBeamColumn', 44006, 4006, 44006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 36976.9216)
    ops.uniaxialMaterial('Elastic', 404006, 71391.59395)
    ...
    # Central joint node
    ops.node(4007, 8.35, 4.45, 9.2, '-mass', 12.85750249229487, 12.85750249229487, 12.85750249229487, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54007, 8.075, 4.45, 9.2)
    ops.element('elasticBeamColumn', 54007, 54007, 4007, 99999, 88888)
    ops.node(34007, 8.625, 4.45, 9.2)
    ...
    ops.node(64007, 8.35, 4.325, 9.2)
    ops.element('elasticBeamColumn', 64007, 64007, 4007, 99999, 77777)
    ops.node(44007, 8.35, 4.575, 9.2)
    ops.element('elasticBeamColumn', 44007, 4007, 44007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 36976.9216)
    ops.uniaxialMaterial('Elastic', 404007, 71391.59395)
    ...
    # Central joint node
    ops.node(4008, 13.8, 4.45, 9.2, '-mass', 8.46774256205222, 8.46774256205222, 8.46774256205222, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 13.55, 4.45, 9.2)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 25399.9652)
    ops.uniaxialMaterial('Elastic', 404008, 55953.72015)
    ...
    # Central joint node
    ops.node(4009, 0.0, 8.9, 9.2, '-mass', 8.467742562052218, 8.467742562052218, 8.467742562052218, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34009, 0.25, 8.9, 9.2)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 25399.9652)
    ops.uniaxialMaterial('Elastic', 404009, 55953.72015)
    ...
    # Central joint node
    ops.node(4010, 5.45, 8.9, 9.2, '-mass', 12.154168640682272, 12.154168640682272, 12.154168640682272, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 5.2, 8.9, 9.2)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 5.7, 8.9, 9.2)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 33135.1058)
    ops.uniaxialMaterial('Elastic', 404010, 61194.4164)
    ...
    # Central joint node
    ops.node(4011, 8.35, 8.9, 9.2, '-mass', 12.154168640682274, 12.154168640682274, 12.154168640682274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 8.1, 8.9, 9.2)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 8.6, 8.9, 9.2)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 33135.1058)
    ops.uniaxialMaterial('Elastic', 404011, 61194.4164)
    ...
    # Central joint node
    ops.node(4012, 13.8, 8.9, 9.2, '-mass', 8.467742562052218, 8.467742562052218, 8.467742562052218, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 13.55, 8.9, 9.2)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 25399.9652)
    ops.uniaxialMaterial('Elastic', 404012, 55953.72015)
    ...
    # Central joint node
    ops.node(4013, 0.0, 13.35, 9.2, '-mass', 4.454207672463417, 4.454207672463417, 4.454207672463417, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64013, 0.0, 13.175, 9.2)
    ops.element('elasticBeamColumn', 64013, 64013, 4013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 16720.2507)
    ops.uniaxialMaterial('Elastic', 404013, 27220.614)
    ...
    # Central joint node
    ops.node(4014, 5.45, 13.35, 9.2, '-mass', 6.377237225539912, 6.377237225539912, 6.377237225539912, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64014, 5.45, 13.175, 9.2)
    ops.element('elasticBeamColumn', 64014, 64014, 4014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 22973.4382)
    ops.uniaxialMaterial('Elastic', 404014, 30977.2544)
    ...
    # Central joint node
    ops.node(4015, 8.35, 13.35, 9.2, '-mass', 6.377237225539913, 6.377237225539913, 6.377237225539913, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64015, 8.35, 13.175, 9.2)
    ops.element('elasticBeamColumn', 64015, 64015, 4015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 22973.4382)
    ops.uniaxialMaterial('Elastic', 404015, 30977.2544)
    ...
    # Central joint node
    ops.node(4016, 13.8, 13.35, 9.2, '-mass', 4.454207672463418, 4.454207672463418, 4.454207672463418, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64016, 13.8, 13.175, 9.2)
    ops.element('elasticBeamColumn', 64016, 64016, 4016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 16720.2507)
    ops.uniaxialMaterial('Elastic', 404016, 27220.614)
