"""
The model used for detailing the structural members of tr_0007 buildings.
"""
...
class Rebars(RebarsBase):
    """The class used for determining rebar solutions tr_0007 beams
    and columns.
    ...
    def _get_min_col_dbh(self, **kwargs) -> float | np.ndarray:
        ...
        References
        ----------
        Section-7.4.1 in TS500 and Section-7.3.4 in TBEC1998
