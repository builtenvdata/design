"""
The model used for detailing the structural members of tr_0018_cdh buildings.
"""
...
class Rebars(RebarsBase):
    """The class used for determining rebar solutions tr_0018_cdh beams
    and columns.
    ...
    def _get_beam_max_sbh(self, **kwargs) -> float | np.ndarray:
        ...
        max_sbh = np.minimum(np.minimum(150 * mm, h / 4), 8 * dbl)
        return max_sbh
