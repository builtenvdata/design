"""
Specific routines for defining and designing tr_0718 buildings.
...
since TBEC-2007 enforces to not consider roof level columns in terms
...
for ground floor columns, which are treated as in TBEC-2007.
3- The method named "_set_beam_capacity_design_shear_forces" overwritten since
the rules are different in TBEC-2007 compared to EN 1998-1:2004.
4- The method named "_predesign" overwritten to add slab type as an input
for predesign_section_dimension method of beams.
"""
...
class Building(BuildingBase):
    """Building object for design class: tr_0718."""
    ...
    def _set_column_capacity_design_shear_forces(self) -> None:
        ...
        for column in self.columns:
            ...
            if (
                ...
                ratio_y_bot = abs(joint_i.top_column.design_forces[1].My1) / (
