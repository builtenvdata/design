"""
Pydantic models for defining materials in tr_7599 buildings.
"""
...
class Steel(SteelBase):
    """Pydantic model representing steel materials for design class tr_7599.
...
class Concrete(ConcreteBase):
    """Pydantic model representing concrete materials for design class tr_7599.
...
class Materials(MaterialsBase):
    ...
    get_next_steel(steel: Steel) -> Steel
        Returns the steel material coming after the given.
    """
