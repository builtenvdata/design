"""
Pydantic models for defining materials in tr_post18 buildings.
"""
...
class Steel(SteelBase):
    """Pydantic model representing steel materials for design class tr_post18.
