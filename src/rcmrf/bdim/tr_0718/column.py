"""
Specific routines for defining and designing tr_0718 columns.
...
# Imports from bdim tr_7500.column library
from ..tr_7500.column import LongReinfAreaCalculator
...
MAX_NIU = 0.50
"""Maximum allowed value of axial load ratio. Section-3.3 in TBEC-2007"""


class Column(ColumnBase):
    """Column object for design class: tr_0718."""
    ...
    def compute_required_transverse_reinforcement(self) -> None:
        ...
        # Transverse reinforcement computation, Section 3.3.7 in TBEC-2007
        if Ve_x <= Vcr_x:
