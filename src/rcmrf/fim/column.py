...
class Column:
    ...
    def _get_hinge_mat_inputs(self, axis=Literal['x', 'y']
        ...
        References
        ----------
        Haselton, C. B., Liel, A. B., Taylor-Lange, S. C., &
        Deierlein, G. G. (2016). Calibration of model to simulate response
        of reinforced concrete beam-columns to collapse. ACI Structural
        Journal, 113(6).
        ...
        # TODO: Where do x1, x2, x3 come from
        x1, y1 = -10, Vn  # coordinates for the first point on the limit curve
        x2, y2 = 0, Vn  # coordinates for the second point on the limit curve
        x3, y3 = 10, Vn  # coordinates for the third point on the limit curve
