"""
Pydantic models for defining loads in tr_0007 buildings.
"""
...
class Variable(VariableBase):
    """
    Model representing live loads (Q) for design class tr_0007.
...
class Permanent(PermanentBase):
    """
    Model representing superimposed dead loads (G) for design class tr_0007.
...
class Combination(CombinationBase):
    """
    Model representing a load combination for design class tr_0007.
...
class DataFormat(DataFormatBase):
    """
    Model representing the format of loads data for design class tr_0007.
