...
def do_gravity() -> None:
    ...
    ops.eleLoad('-ele', 4050, '-type', '-beamUniform', -17.2825, 0.0)
    ...
    ops.eleLoad('-ele', 1034, '-type', '-beamUniform', -9.4, 0.0)
    ...
    ops.eleLoad('-ele', 1039, '-type', '-beamUniform', -9.4, 0.0)
    ...
    ops.eleLoad('-ele', 3034, '-type', '-beamUniform', -8.68, 0.0)
    ...
    ops.eleLoad('-ele', 3039, '-type', '-beamUniform', -8.68, 0.0)
    ...
    ops.load(170001, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(121001, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(170006, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(121006, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(170007, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(121007, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(170008, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(121008, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(170009, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(121009, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(170010, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(121010, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(170011, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(121011, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(170012, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(121012, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(170013, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(121013, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(170018, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(121018, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(171001, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(122001, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(171006, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(122006, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(171007, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(122007, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(171008, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(122008, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(171009, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(122009, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(171010, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(122010, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(171011, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(122011, 0.0, 0.0, -6.4395, 0.0, 0.0, 0.0)
    ops.load(171012, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(122012, 0.0, 0.0, -5.088, 0.0, 0.0, 0.0)
    ops.load(171013, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(122013, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(171018, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(122018, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(172007, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(123007, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(172008, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(123008, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(172011, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(123011, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(172012, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(123012, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(173007, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(124007, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(173008, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(124008, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(173011, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(124011, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(173012, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ops.load(124012, 0.0, 0.0, -3.8955, 0.0, 0.0, 0.0)
    ...
    ops.load(170003, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(124019, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(174019, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(121003, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(170004, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(124020, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(174020, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(121004, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(171003, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(124021, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(174021, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(122003, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(171004, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(124022, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(174022, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(122004, 0.0, 0.0, -2.544, 0.0, 0.0, 0.0)
    ops.load(172003, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(124023, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(174023, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(123003, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(172004, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(124024, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(174024, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(123004, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(173003, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(124025, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(174025, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(124003, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(173004, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(124026, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(174026, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
    ops.load(124004, 0.0, 0.0, -1.94775, 0.0, 0.0, 0.0)
